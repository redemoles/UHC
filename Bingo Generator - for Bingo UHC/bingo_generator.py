...
def generate_bingo(zip_file, bingo_size, bingo_namespace, bingo_name, step_number, advancements_folder, configuration_objective, max_square_objective, icon_item, title_color, description, description_color, background):
...
# Function to generate a bingo and add it to the zip file
def generate_bingo_inverted(zip_file, bingo_size, bingo_namespace, bingo_name, step_number, advancements_folder, configuration_objective, max_square_objective, icon_item, title_color, description, description_color, background):
	# Create the root advancement
	root_advancement = dict(json.loads(f"""
{{
	"display": {{
...
# Create a single data pack containing both bingos
with zipfile.ZipFile(f"Bingo_UHC_grids_{datetime.datetime.today().strftime('%Y-%m-%d_%H-%M-%S')}.zip", "w") as zip_file:
	
	# Generate first bingo: Classic Bingo A - Scenario: Vanilla
	generate_bingo(
		zip_file,
		bingo_size={"lines": 5, "columns": 5},
		bingo_namespace="bingo_0a",
		bingo_name="Classic Bingo A",
		step_number="1",
	...
	# Generate second bingo: Classic Bingo B - Scenario: Vanilla
	generate_bingo(
		zip_file,
		bingo_size={"lines": 5, "columns": 5},
		bingo_namespace="bingo_0b",
		bingo_name="Classic Bingo B",
		step_number="2",
		advancements_folder="items_all",
		configuration_objective="bhc.data",
	...
	# Generate first bingo: Classic Bingo - Scenario: Gold Rush
	generate_bingo(
		zip_file,
		bingo_size={"lines": 5, "columns": 5},
		bingo_namespace="bingo_1a",
		bingo_name="Classic Bingo",
		step_number="1",
		advancements_folder="items_all",
		configuration_objective="bhc.data",
		max_square_objective="bhc.stepa.case",
	...
	# Generate second bingo: Gold Rush Bingo - Scenario: Gold Rush
	generate_bingo(
		zip_file,
		bingo_size={"lines": 7, "columns": 7},
		bingo_namespace="bingo_1b",
		bingo_name="Gold Rush",
		step_number="2",
		advancements_folder="items_all",
		configuration_objective="bhc.data",
		max_square_objective="bhc.stepb.case",
	...
	# Generate first bingo: Classic Bingo - Scenario: Viking Era
	generate_bingo(
		zip_file,
		bingo_size={"lines": 5, "columns": 5},
	...
	# Generate second bingo: Viking Era Bingo - Scenario: Viking Era
	generate_bingo(
		zip_file,
		bingo_size={"lines": 6, "columns": 6},
		bingo_namespace="bingo_2b",
		bingo_name="Viking Era",
		step_number="2",
	...
	# Generate second bingo: A cissalC ogniB - Scenario: April's Fool Day 2026
	generate_bingo_inverted(
		zip_file,
		bingo_size={"lines": 5, "columns": 5},
		bingo_namespace="bingo_51a",
		bingo_name="A cissalC ogniB",
		step_number="1",
		advancements_folder="items_all",
		configuration_objective="bhc.data",
		max_square_objective="bhc.stepb.case",
	...
	# Generate second bingo: Grille Basique 2 - Scenario: April's Fool Day 2026
	generate_bingo(
		zip_file,
		bingo_size={"lines": 5, "columns": 5},
	...
	# Generate second bingo: Bingo - Scenario: Bingo UHC Run
	generate_bingo(
		zip_file,
		bingo_size={"lines": 9, "columns": 9},
		bingo_namespace="bingo_91",
		bingo_name="Bingo",
		step_number="1",
		advancements_folder="items_all_91",
		configuration_objective="bhc.data",
		max_square_objective="bhc.stepa.case",
		icon_item="minecraft:paper",
		title_color="#B73FFF",
	...
	# Generate first bingo: Classic Bingo A - Scenario: Chill mode (2 grids)
	generate_bingo(
		zip_file,
		bingo_size={"lines": 5, "columns": 5},
		bingo_namespace="bingo_92a",
		bingo_name="Classic Bingo A",
		step_number="1",
		advancements_folder="items_all",
		configuration_objective="bhc.data",
	...
	# Generate second bingo: Classic Bingo B - Scenario: Chill mode (2 grids)
	generate_bingo(
		zip_file,
		bingo_size={"lines": 5, "columns": 5},
		bingo_namespace="bingo_92b",
		bingo_name="Classic Bingo B",
		step_number="2",
		advancements_folder="items_all",
		configuration_objective="bhc.data",
