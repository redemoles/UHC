...
link = "https://raw.githubusercontent.com/PixiGeko/Minecraft-generated-data/master/1.21/releases/1.21.11/custom-generated/registries/item.txt"
...
block_should_not_contains = ["command_block", "test", "spawn", "infested", "banner_pattern", "template", "chainmail", "netherite", "frog", "turtle", "head", "sherd", "torchflower", "pitcher", "copper_horse", "n_horse", "d_horse", "red_nether", "music_disc", "golem", "nautilus_armor"]
...
slime_block = ["slime", "sticky_piston", "tadpole"]
slime = []
slime = [block for block in blocks if any(x in block for x in slime_block)]

trial_chamber_block = ["mace", "heavy_core", "trial", "ominous", "breeze_rod", "wind_charge"]
trial_chamber = []
...
cherry_block = ["cherry", "petals"]
cherry = []
#cherry = [block for block in blocks if any(x in block for x in cherry_block)]
...
too_easy_block_list = ["planks", "button", "dye", "nugget"]
too_easy = []
...
blocks = [block for block in blocks
		  ...
		  and block not in cherry					# And, if the block is in the cherry list
