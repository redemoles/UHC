...
link = "https://raw.githubusercontent.com/PixiGeko/Minecraft-generated-data/master/1.21/releases/1.21.10/custom-generated/registries/item.txt"
...
block_should_not_contains = ["command_block", "test", "spawn", "infested", "banner_pattern", "template", "chainmail", "netherite", "frog", "turtle", "head", "sherd", "torchflower", "pitcher", "copper_horse", "n_horse", "d_horse", "red_nether", "music_disc", "golem"]
