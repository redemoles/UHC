...
## ATTAQUE
execute if score @s nzl.dragon.malus matches 0 if entity @n[type=marker,predicate=uhc:id_team,scores={nzl.attack.length.03=1..}] run function nzl:types/move/attack/dragon
