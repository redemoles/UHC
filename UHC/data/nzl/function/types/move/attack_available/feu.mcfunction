...
execute if score @s nzl.attack.cooldown.07 matches 1.. run data modify storage nzl:temp move.type set value "07"
execute if score @s nzl.attack.cooldown.07 matches 1.. as @p[scores={nzl.type.player=07,nzl.attack.no_flood=0},predicate=uhc:id/team] run function uhc:translation/nzl/move_cooldown with storage nzl:temp move
