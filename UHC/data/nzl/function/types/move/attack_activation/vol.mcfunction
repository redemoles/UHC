...
data modify storage nzl:temp move.type set value "18"
execute as @p[scores={nzl.type.player=18},predicate=uhc:id/team] run function uhc:translation/nzl/move_attack_activation with storage nzl:temp move.type
