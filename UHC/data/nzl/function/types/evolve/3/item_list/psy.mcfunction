...
#> nzl:types/evolve/3/item_list/psy
#
# @within			nzl:types/evolve/3/disponible/psy
#
#
...
execute unless entity @s[scores={nzl.type.player=13,nzl.item1=0..,nzl.item2=0..,nzl.item3=0..,nzl.item4=0..,uhc.player.kills=1..},level=15..] run scoreboard players set @s nzl.type.evolve 0
...
# Réussite
execute if score @s nzl.type.evolve matches 3 run function nzl:types/evolve/3/succes/psy with storage nzl psy_3_chat
