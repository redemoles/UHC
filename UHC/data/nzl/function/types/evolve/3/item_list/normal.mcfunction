...
#> nzl:types/evolve/3/item_list/normal
#
# @within			nzl:types/evolve/3/disponible/normal
#
#
...
execute unless entity @s[scores={nzl.type.player=10,nzl.item1=0..,nzl.item2=0..,nzl.item3=0..,nzl.item4=0..,uhc.player.kills=1..},level=15..] run scoreboard players set @s nzl.type.evolve 0
...
# Réussite
execute if score @s nzl.type.evolve matches 3 run function nzl:types/evolve/3/succes/normal with storage nzl normal_3_chat
