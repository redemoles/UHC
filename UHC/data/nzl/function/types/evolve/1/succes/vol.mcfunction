...
tag @s add nzl.type.18

# Équipe
scoreboard players operation #team uhc.id.team = @s uhc.id.team
tag @e[type=minecraft:marker,tag=UHC,predicate=uhc:id/team] add nzl.type.18
...
scoreboard players remove @n[type=minecraft:marker,tag=nzl.type,tag=18] nzl.type.available 1
scoreboard players remove #type_18 nzl.type.available 1

scoreboard players set @s nzl.type.evolve 0
scoreboard players set @s[scores={nzl.type.select=18}] nzl.type.player 18

## Préfix
function nzl:types/prefix/vol
