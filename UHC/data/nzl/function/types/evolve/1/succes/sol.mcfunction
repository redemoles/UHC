...
tag @s add nzl.type.15

# Équipe
scoreboard players operation #team uhc.id.team = @s uhc.id.team
tag @e[type=minecraft:marker,tag=UHC,predicate=uhc:id/team] add nzl.type.15
...
scoreboard players remove @n[type=minecraft:marker,tag=nzl.type,tag=15] nzl.type.available 1
scoreboard players remove #type_15 nzl.type.available 1

scoreboard players set @s nzl.type.evolve 0
scoreboard players set @s[scores={nzl.type.select=15}] nzl.type.player 15

## Préfix
function nzl:types/prefix/sol
