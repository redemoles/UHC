...
#> nzl:types/evolve/1/succes/tenebres
#
...
tag @s add nzl.type.17

# Équipe
scoreboard players operation #team uhc.id.team = @s uhc.id.team
tag @e[type=minecraft:marker,tag=UHC,predicate=uhc:id/team] add nzl.type.17
...
scoreboard players remove @n[type=minecraft:marker,tag=nzl.type,tag=17] nzl.type.available 1
scoreboard players remove #type_17 nzl.type.available 1

scoreboard players set @s nzl.type.evolve 0
scoreboard players set @s[scores={nzl.type.select=17}] nzl.type.player 17

## Préfix
function nzl:types/prefix/tenebres
