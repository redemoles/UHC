...
#> nzl:types/evolve/1/succes/normal
#
...
tag @s add nzl.type.10

# Équipe
scoreboard players operation #team uhc.id.team = @s uhc.id.team
tag @e[type=minecraft:marker,tag=UHC,predicate=uhc:id/team] add nzl.type.10
...
scoreboard players remove @n[type=minecraft:marker,tag=nzl.type,tag=10] nzl.type.available 1
scoreboard players remove #type_10 nzl.type.available 1

scoreboard players set @s nzl.type.evolve 0
scoreboard players set @s[scores={nzl.type.select=10}] nzl.type.player 10

## Préfix
function nzl:types/prefix/normal
