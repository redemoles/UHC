...
tag @s add nzl.type.07

# Équipe
scoreboard players operation #team uhc.id.team = @s uhc.id.team
tag @e[type=minecraft:marker,tag=UHC,predicate=uhc:id/team] add nzl.type.07
...
scoreboard players remove @n[type=minecraft:marker,tag=nzl.type,tag=07] nzl.type.available 1
scoreboard players remove #type_07 nzl.type.available 1

scoreboard players set @s nzl.type.evolve 0
scoreboard players set @s[scores={nzl.type.select=07}] nzl.type.player 07

## Préfix
function nzl:types/prefix/feu
