...
#> nzl:types/evolve/1/succes/roche
#
...
tag @s add nzl.type.14

# Équipe
scoreboard players operation #team uhc.id.team = @s uhc.id.team
tag @e[type=minecraft:marker,tag=UHC,predicate=uhc:id/team] add nzl.type.14
...
scoreboard players set @s[scores={nzl.type.select=14}] nzl.type.player 14

## Préfix
function nzl:types/prefix/roche
