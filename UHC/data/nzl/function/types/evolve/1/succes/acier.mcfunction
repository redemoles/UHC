...
tag @e[type=minecraft:marker,tag=UHC,predicate=uhc:id/team] add nzl.type.01
...
scoreboard players remove @n[type=minecraft:marker,tag=nzl.type,tag=01] nzl.type.available 1
