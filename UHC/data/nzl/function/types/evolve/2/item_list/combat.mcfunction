...
#> nzl:types/evolve/2/item_list/combat
#
# @within			nzl:types/evolve/2/disponible/combat
#
#
...
scoreboard players operation @s nzl.item2 = @s nzl.goal.zombies_killed
...
execute unless entity @s[scores={nzl.type.select=02,nzl.item1=0..,nzl.item2=20..,nzl.item3=0..,nzl.item4=0..,nzl.item5=0..},level=15..] run scoreboard players set @s nzl.type.select 99

# Echec
tellraw @s[scores={nzl.type.evolve=0}] [{"text":"Tu n'as pas tous les éléments requis pour évoluer.","color":"#FF3F3F","bold":false}]
tellraw @s[scores={nzl.type.evolve=0,nzl.item2=..19}] [{"text":"Zombies tués : ","color":"#FF5F5F","bold":false},{"score":{"name":"@s","objective":"nzl.item2"}},{"text":"/20"}]
...
tellraw @s[scores={nzl.type.evolve=0,nzl.item2=20..}] [{"text":"Zombies tués : ","color":"#5FAFFF","bold":false},{"score":{"name":"@s","objective":"nzl.item2"}},{"text":"/20"}]
...
# Réussite
execute if score @s nzl.type.evolve matches 2 run function nzl:types/evolve/2/succes/combat with storage nzl combat_2_chat
