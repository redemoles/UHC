...
#> nzl:types/evolve/2/item_list/vol
#
# @within			nzl:types/evolve/2/disponible/vol
#
#
...
execute unless entity @s[scores={nzl.type.player=18,nzl.item1=0..,nzl.item2=1..,nzl.item3=1..,nzl.item4=64..,nzl.item5=0..},level=15..] run scoreboard players set @s nzl.type.evolve 0
...
# Réussite
execute if score @s nzl.type.evolve matches 2 run function nzl:types/evolve/2/succes/vol with storage nzl vol_2_chat
