...
#> nzl:types/evolve/2/item_list/feu
#
# @within			nzl:types/evolve/2/disponible/feu
#
#
...
execute unless entity @s[scores={nzl.type.player=07,nzl.item1=0..,nzl.item2=1..,nzl.item3=1..,nzl.item4=64..,nzl.item5=0..},level=15..] run scoreboard players set @s nzl.type.evolve 0
...
# Réussite
execute if score @s nzl.type.evolve matches 2 run function nzl:types/evolve/2/succes/feu with storage nzl feu_2_chat
