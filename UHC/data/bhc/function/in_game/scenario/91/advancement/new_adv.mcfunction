...
#> bhc:in_game/scenario/91/advancement/new_adv
#
...
$execute in uhc:lobby as @n[type=minecraft:marker,tag=UHC,distance=0..,predicate=uhc:id/team] run function bhc:in_game/scenario/91/advancement/new_adv_1 with storage $(namespace) $(line)_$(column)
...
## Récompenses
$execute if score #stepa_enabled bhc.data matches $(step) run function bhc:in_game/scenario/91/bingo_stepa/player_reward/case with storage $(namespace) $(line)_$(column)
