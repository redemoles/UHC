...
#> bhc:in_game/scenario/02/target/randomizer/countdown
#
...
execute if score #tracker_ennemies uhc.data.temp matches 0 run function bhc:in_game/scenario/02/target/randomizer/main
