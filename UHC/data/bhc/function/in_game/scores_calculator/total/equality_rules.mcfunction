...
#> bhc:in_game/scores_calculator/total/equality_rules
#
...
execute unless score #bhc bhc.scenario matches 91..98 run scoreboard players add @s[predicate=uhc:id/team_alive] bhc.total.tie_break.score 100
