...
#> bhc:in_game/scores_calculator/death/rank
#
...
execute unless score @s bhc.kills.score.inv matches 10000000.. run function bhc:in_game/scores_calculator/kills/scores_1
