...
#> bhc:in_game/scores_calculator/death/ironman/remove_1
#
# @within			bhc:in_game/scores_calculator/death/ironman/remove
#
#
...
function bhc:in_game/scores_calculator/death/ironman/bonus
