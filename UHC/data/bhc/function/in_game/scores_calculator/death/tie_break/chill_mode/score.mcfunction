...
#> bhc:in_game/scores_calculator/death/tie_break/chill_mode/score
#
# @within			bhc:in_game/scores_calculator/death/tie_break/chill_mode/
# 
#
...
scoreboard players operation @s bhc.chill_mode.tie_break.score += @s bhc.stepa.rank.score.inv
