...
execute if score #seconds uhc.data.temp matches 15 run scoreboard players set #sb bhc.data.temp 13
execute if score #seconds uhc.data.temp matches 30 run scoreboard players set #sb bhc.data.temp 13
execute if score #seconds uhc.data.temp matches 45 run scoreboard players set #sb bhc.data.temp 13

execute if score #seconds uhc.data.temp matches 00 run scoreboard objectives setdisplay sidebar bhc.bingo.score.sb1
execute if score #seconds uhc.data.temp matches 15 run scoreboard objectives setdisplay sidebar bhc.bingo.score.sb2
