...
execute if score #seconds uhc.data.temp matches 00 run scoreboard objectives setdisplay sidebar bhc.stepa.score.sb1
execute if score #seconds uhc.data.temp matches 15 run scoreboard objectives setdisplay sidebar bhc.stepa.score.sb2
execute if score #seconds uhc.data.temp matches 30 run scoreboard objectives setdisplay sidebar bhc.stepa.score.sb1
execute if score #seconds uhc.data.temp matches 45 run scoreboard objectives setdisplay sidebar bhc.stepa.score.sb2
