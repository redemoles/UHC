...
execute if score #bhc bhc.scenario matches 91..98 if score #game_progress uhc.game_progress matches 2 run function bhc:scores_calculator/death/tie_break/chill_mode/
