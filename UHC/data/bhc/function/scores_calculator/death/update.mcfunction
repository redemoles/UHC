...
execute as @e[type=marker,tag=UHC,distance=0..] run function bhc:scores_calculator/death/tie_break/score
execute as @e[type=marker,tag=UHC,distance=0..] run function bhc:scores_calculator/death/tie_break/rank

# Score Survie
execute as @e[type=marker,tag=UHC,distance=0..] run function bhc:scores_calculator/death/score
