...
## Timers
execute if score #bhc bhc.scenario matches 00 run function bhc:scenario/00/timer/config
execute if score #bhc bhc.scenario matches 01 run function bhc:scenario/01/timer/config
