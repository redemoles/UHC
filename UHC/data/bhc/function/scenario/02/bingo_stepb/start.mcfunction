...
#> bhc:scenario/02/bingo_stepb/start
#
...
tellraw @a[scores={uhc.player.lang=061801}] [{"text":"[","color":"#FFFFFF","bold":true},{"text":"Bingo","color":"#B73FFF"},{"text":"UHC","color":"#FFE73F"},{"text":"]","color":"#FFFFFF"},{"text":" Début de l'","color":"#FFFFFF","bold":false},{"text":"Ère Viking","color":"#CF6F3F","bold":true},{"text":" !","color":"#FFFFFF","bold":false}]
tellraw @a[scores={uhc.player.lang=051407}] [{"text":"[","color":"#FFFFFF","bold":true},{"text":"Bingo","color":"#B73FFF"},{"text":"UHC","color":"#FFE73F"},{"text":"]","color":"#FFFFFF"},{"text":" Start of the ","color":"#FFFFFF","bold":false},{"text":"Viking Era","color":"#CF6F3F","bold":true},{"text":"!","color":"#FFFFFF","bold":false}]
...
# Reset des succès
execute as @e[type=minecraft:marker,tag=UHC,distance=0..] run function bhc:scenario/02/timer/reset_scores
