...
execute unless score @s bhc.target.known matches 2 unless entity @n[type=minecraft:marker,tag=UHC,distance=0..,predicate=!bhc:bhc_2/safe_target,predicate=bhc:bhc_2/this_is_targeted] run return run function bhc:scenario/02/target/hotbar/no_target
