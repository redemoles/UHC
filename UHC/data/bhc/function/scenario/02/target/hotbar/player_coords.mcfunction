...
#> bhc:scenario/02/target/hotbar/player_coords
#
...
execute if entity @s[predicate=uhc:dimension/overworld] if entity @p[tag=uhc.target.targeted_current,predicate=uhc:dimension/overworld] run function bhc:scenario/02/target/hotbar/dimension_same
execute if entity @s[predicate=uhc:dimension/the_end] if entity @p[tag=uhc.target.targeted_current,predicate=uhc:dimension/the_end] run function bhc:scenario/02/target/hotbar/dimension_same
execute if entity @s[predicate=uhc:dimension/the_nether] if entity @p[tag=uhc.target.targeted_current,predicate=uhc:dimension/the_nether] run function bhc:scenario/02/target/hotbar/dimension_same
execute if entity @s[predicate=uhc:dimension/overworld] unless entity @p[tag=uhc.target.targeted_current,predicate=uhc:dimension/overworld] run function bhc:scenario/02/target/hotbar/dimension_diff
execute if entity @s[predicate=uhc:dimension/the_end] unless entity @p[tag=uhc.target.targeted_current,predicate=uhc:dimension/the_end] run function bhc:scenario/02/target/hotbar/dimension_diff
execute if entity @s[predicate=uhc:dimension/the_nether] unless entity @p[tag=uhc.target.targeted_current,predicate=uhc:dimension/the_nether] run function bhc:scenario/02/target/hotbar/dimension_diff
