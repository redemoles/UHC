...
execute if score #cycle bhc.target.cycle matches 2.. as @n[type=marker,tag=UHC,distance=0..,scores={bhc.targeter.id=1}] run function bhc:scenario/02/target/randomizer/randomizer
# Annonce aux joueurs
