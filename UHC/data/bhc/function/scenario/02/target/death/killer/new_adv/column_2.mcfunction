...
#> bhc:scenario/02/target/death/killer/new_adv/column_2
#
# @within			bhc:scenario/02/target/death/killer/new_adv/column_1
#
#
...
function bhc:scenario/02/target/death/killer/new_adv/case with storage bhc:temp new_adv.selected
