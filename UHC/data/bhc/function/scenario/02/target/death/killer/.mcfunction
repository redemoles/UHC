...
execute if entity @s[predicate=bhc:bhc_2/this_is_targeted,predicate=!bhc:bhc_2/this_is_targeter] as @a[predicate=uhc:id/team,scores={uhc.player.lang=051407}] run tellraw @s [{"text":"+5","color":"#3FE7FF","bold":true},{"text":" points ","color":"#00C3DF","bold":false},{"text":"[","color":"#FFFFFF"},{"text":"Kills","color":"#3FE7FF"},{"text":"] ","color":"#FFFFFF"},{"text":"Assassin killed","color":"#CFCFCF","italic":true,"bold":false}]
...
execute if score #stepb_end bhc.data.temp matches 1.. if entity @s[predicate=!bhc:bhc_2/this_is_targeter,predicate=!bhc:bhc_2/this_is_targeted] as @a[predicate=uhc:id/team,scores={uhc.player.lang=061801}] run tellraw @s [{"text":"-5","color":"#FF3F3F","bold":true},{"text":" points ","color":"#DF0000","bold":false},{"text":"[","color":"#FFFFFF"},{"text":"Kills","color":"#3FE7FF"},{"text":"] ","color":"#FFFFFF"}]
execute if score #stepb_end bhc.data.temp matches 1.. if entity @s[predicate=!bhc:bhc_2/this_is_targeter,predicate=!bhc:bhc_2/this_is_targeted] as @a[predicate=uhc:id/team,scores={uhc.player.lang=051407}] run tellraw @s [{"text":"-5","color":"#FF3F3F","bold":true},{"text":" points ","color":"#DF0000","bold":false},{"text":"[","color":"#FFFFFF"},{"text":"Kills","color":"#3FE7FF"},{"text":"] ","color":"#FFFFFF"}]
execute if score #stepb_end bhc.data.temp matches ..0 if entity @s[predicate=!bhc:bhc_2/this_is_targeter,predicate=!bhc:bhc_2/this_is_targeted] as @a[predicate=uhc:id/team,scores={uhc.player.lang=061801}] run tellraw @s [{"text":"+1","color":"#3FE7FF","bold":true},{"text":" points ","color":"#00C3DF","bold":false},{"text":"[","color":"#FFFFFF"},{"text":"Kills","color":"#3FE7FF"},{"text":"] ","color":"#FFFFFF"}]
execute if score #stepb_end bhc.data.temp matches ..0 if entity @s[predicate=!bhc:bhc_2/this_is_targeter,predicate=!bhc:bhc_2/this_is_targeted] as @a[predicate=uhc:id/team,scores={uhc.player.lang=051407}] run tellraw @s [{"text":"+1","color":"#3FE7FF","bold":true},{"text":" points ","color":"#00C3DF","bold":false},{"text":"[","color":"#FFFFFF"},{"text":"Kills","color":"#3FE7FF"},{"text":"] ","color":"#FFFFFF"}]
