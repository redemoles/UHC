...
#> bhc:scenario/02/target/death/killer/new_adv/line_1
#
# @within			bhc:scenario/02/target/death/killer/new_adv/line
#
#
...
function bhc:scenario/02/target/death/killer/new_adv/line_2 with storage bhc:temp new_adv.line
