...
execute if score @s[predicate=!bhc:bhc_2/last_death_same_cycle] uhc.player.lives matches 1 as @e[type=marker,tag=UHC,distance=0..,predicate=uhc:id/team] run scoreboard players remove @s bhc.target.team.live 1
...
execute if score @s uhc.player.lives matches 1 as @e[type=marker,tag=UHC,distance=0..,predicate=uhc:id/team,scores={uhc.player.lives=1}] run function bhc:scenario/02/target/death/team_out
