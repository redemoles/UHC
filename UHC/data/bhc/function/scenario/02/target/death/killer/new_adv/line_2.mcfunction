...
#> bhc:scenario/02/target/death/killer/new_adv/line_2
#
# @within			bhc:scenario/02/target/death/killer/new_adv/line_1
#
#
...
function bhc:scenario/02/target/death/killer/new_adv/column with storage bhc:temp new_adv.selected
...
function bhc:scenario/02/target/death/killer/new_adv/line_1 with storage bhc:temp new_adv.line
