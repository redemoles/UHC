...
#> bhc:scenario/02/bingo_stepa/start
#
...
function uhc:translation/bhc/02_viking_era/bingo_a_start
...
data modify storage bhc:temp scoreboard.bingo set value "bingo_2a"
