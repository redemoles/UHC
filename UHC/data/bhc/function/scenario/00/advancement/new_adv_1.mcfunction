...
$execute as @p[tag=bhc.new_adv] run function bhc:scenario/00/advancement/message_case_team with storage $(namespace) $(line)_$(column)
...
$execute unless score #team_first_completion bhc.data matches 1 if score #team_first_line_$(line) bhc.data matches 1 run function bhc:scenario/00/advancement/message_line with storage $(namespace) $(line)_$(column)
$execute unless score #team_first_completion bhc.data matches 1 if score #team_first_column_$(column) bhc.data matches 1 run function bhc:scenario/00/advancement/message_column with storage $(namespace) $(line)_$(column)
$execute if score #team_first_completion bhc.data matches 1 run function bhc:scenario/00/advancement/message_completed with storage $(namespace) $(line)_$(column)
