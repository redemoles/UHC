...
#> bhc:scenario/00/advancement/new_adv
#
...
## Scores
$execute if score #stepa_enabled bhc.data matches $(step) run function bhc:scenario/00/bingo_stepa/team_reward/case with storage $(namespace) $(line)_$(column)
$execute if score #stepb_enabled bhc.data matches $(step) run function bhc:scenario/00/bingo_stepb/team_reward/case with storage $(namespace) $(line)_$(column)
