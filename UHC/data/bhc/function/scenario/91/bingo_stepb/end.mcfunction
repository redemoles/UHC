...
#> bhc:scenario/91/bingo_stepb/end
#
...
# Msg FRA
execute as @a[scores={uhc.player.lang=061801}] run tellraw @s [{"text":"\n[","color":"#FFFFFF","bold":true},{"text":"Bingo","color":"#B73FFF"},{"text":"UHC","color":"#FFE73F"},{"text":"]","color":"#FFFFFF"},{"text":" ","bold":false},{"text":"Bingo Classique B","color":"#B73FFF","bold":true},{"text":" terminée !","color":"#FFFFFF","bold":false}]
