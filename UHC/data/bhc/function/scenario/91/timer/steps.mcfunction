...
# Bingo Classique B
execute if score #stepb_start bhc.data.temp matches 0 run function bhc:scenario/91/bingo_stepb/start
execute if score #stepb_end bhc.data.temp matches 0 run function bhc:scenario/91/bingo_stepb/end
