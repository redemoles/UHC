...
#> bhc:scenario/51/bingo_stepa/start
#
...
# Activation du Bingo
scoreboard players set #bingo_51a_enabled bhc.data 1
scoreboard players set #stepa_enabled bhc.data 1

tellraw @a[scores={uhc.player.lang=061801}] [{"text":"[","color":"#FFFFFF","bold":true},{"text":"Bingo","color":"#B73FFF"},{"text":"UHC","color":"#FFE73F"},{"text":"]","color":"#FFFFFF"},{"text":" Début du ","color":"#FFFFFF","bold":false},{"text":"A euqissalC ogniB","color":"#B73FFF","bold":true}]
tellraw @a[scores={uhc.player.lang=051407}] [{"text":"[","color":"#FFFFFF","bold":true},{"text":"Bingo","color":"#B73FFF"},{"text":"UHC","color":"#FFE73F"},{"text":"]","color":"#FFFFFF"},{"text":" Start of ","color":"#FFFFFF","bold":false},{"text":"A ogniB cissalC","color":"#B73FFF","bold":true}]
...
data modify storage bhc:temp scoreboard.bingo set value "bingo_51a"
