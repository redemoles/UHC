...
# Msg FRA
execute as @a[scores={uhc.player.lang=061801}] run tellraw @s [{"text":"\n[","color":"#FFFFFF","bold":true},{"text":"Bingo","color":"#B73FFF"},{"text":"UHC","color":"#FFE73F"},{"text":"]","color":"#FFFFFF"},{"text":" ","bold":false},{"text":"A euqissalC ogniB","color":"#B73FFF","bold":true},{"text":" terminé !","color":"#FFFFFF","bold":false}]
...
# Msg ENG
execute as @a[scores={uhc.player.lang=051407}] run tellraw @s [{"text":"\n[","color":"#FFFFFF","bold":true},{"text":"Bingo","color":"#B73FFF"},{"text":"UHC","color":"#FFE73F"},{"text":"]","color":"#FFFFFF"},{"text":" ","bold":false},{"text":"A ogniB cissalC","color":"#B73FFF","bold":true},{"text":" is over!","color":"#FFFFFF","bold":false}]
