...
scoreboard players set #stepa_multiplier bhc.data.setup 4

# Étape B : Bingo Classique B
...
scoreboard players set #stepb_multiplier bhc.data.setup 4

scoreboard players set #kills_multiplier bhc.data.setup 0
scoreboard players set #death_multiplier bhc.data.setup 2
