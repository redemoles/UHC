...
$execute in uhc:lobby as @n[type=minecraft:marker,tag=UHC,distance=0..,predicate=uhc:id/team] run function bhc:scenario/92/advancement/new_adv_1 with storage $(namespace) $(line)_$(column)
