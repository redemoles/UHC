...
#> bhc:scenario/01/bingo_stepa/start
#
...
# Reset des succès
execute as @e[type=marker,tag=UHC,distance=0..] run function bhc:scenario/01/timer/reset_scores

data modify storage bhc:temp scoreboard.bingo set value "bingo_1a"
