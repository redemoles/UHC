...
$execute if score #$(namespace)_$(line)_$(column) bhc.case matches ..0 function uhc:translation/bhc/01_gold_rush/bingo_b_exhaustion_square with storage $(namespace) $(line)_$(column)
