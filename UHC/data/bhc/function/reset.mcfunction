...
scoreboard objectives remove bhc.kills.damage_dealt.rank
scoreboard objectives remove bhc.kills.damage_dealt.inv
...
scoreboard objectives remove bhc.bingo.score.sb1
scoreboard objectives remove bhc.bingo.score.sb2
scoreboard objectives remove bhc.stepa.score
scoreboard objectives remove bhc.stepa.score.sb1
scoreboard objectives remove bhc.stepa.score.sb2
scoreboard objectives remove bhc.stepb.score
scoreboard objectives remove bhc.stepb.score.sb1
scoreboard objectives remove bhc.stepb.score.sb2
...
scoreboard objectives remove bhc.total.score.sb1
scoreboard objectives remove bhc.total.score.sb2

scoreboard objectives remove bhc.bingo.rank.score.inv
...
scoreboard objectives remove bhc.bingo.rank.score
scoreboard objectives remove bhc.bingo.rank.score.sb1
scoreboard objectives remove bhc.bingo.rank.score.sb2
scoreboard objectives remove bhc.stepa.rank.score
scoreboard objectives remove bhc.stepa.rank.score.sb1
scoreboard objectives remove bhc.stepa.rank.score.sb2
...
scoreboard objectives remove bhc.bingo.rank.number
...
scoreboard objectives remove bhc.death.tie_break.score.inv
scoreboard objectives remove bhc.death.tie_break.rank.number
scoreboard objectives remove bhc.death.tie_break.rank.score
scoreboard objectives remove bhc.chill_mode.tie_break.score
scoreboard objectives remove bhc.chill_mode.tie_break.rank

scoreboard objectives remove bhc.total.tie_break.score
scoreboard objectives remove bhc.total.tie_break.rank
...
scoreboard objectives remove bhc.completion
...
scoreboard objectives remove bhc.target.dead.temp
scoreboard objectives remove bhc.target.team.live
scoreboard objectives remove bhc.target.list
scoreboard objectives remove bhc.target.sort

scoreboard objectives remove bhc.test.target_kill

team remove bhc.sb.01
team remove bhc.sb.02
team remove bhc.sb.03
team remove bhc.sb.04
team remove bhc.sb.05
team remove bhc.sb.06
team remove bhc.sb.07
team remove bhc.sb.08
team remove bhc.sb.09
team remove bhc.sb.10
team remove bhc.sb.11
team remove bhc.sb.12
team remove bhc.sb.13
team remove bhc.sb.14
team remove bhc.sb.15
team remove bhc.sb.16
team remove bhc.sb.17
team remove bhc.sb.18
team remove bhc.sb.19
team remove bhc.sb.20
team remove bhc.sb.21
team remove bhc.sb.22
team remove bhc.sb.23
team remove bhc.sb.24
team remove bhc.sb.25
team remove bhc.sb.26
team remove bhc.sb.27
team remove bhc.sb.28
team remove bhc.sb.29
team remove bhc.sb.30
team remove bhc.sb.31
team remove bhc.sb.32
...
scoreboard objectives add bhc.bingo.score.sb1 dummy [{"text":"Bingos C.","color":"#FFFFFF"},{"text":" & ","color":"#FFE73F"},{"text":"Spé.","color":"#FFFFFF"}]
scoreboard objectives add bhc.bingo.score.sb2 dummy [{"text":"Bingos C.","color":"#FFFFFF"},{"text":" & ","color":"#FFE73F"},{"text":"Spé.","color":"#FFFFFF"}]
...
scoreboard objectives add bhc.stepa.score.sb1 dummy [{"text":"Bingo C. ","color":"#FFFFFF"},{"text":">","color":"#00C3DF","bold":true},{"text":" Équipes","color":"#FFFFFF"}]
scoreboard objectives add bhc.stepa.score.sb2 dummy [{"text":"Bingo C. ","color":"#FFFFFF"},{"text":">","color":"#00C3DF","bold":true},{"text":" Équipes","color":"#FFFFFF"}]
...
scoreboard objectives add bhc.stepb.score.sb1 dummy [{"text":"Bingo Spé. ","color":"#FFFFFF"},{"text":">","color":"#00C3DF","bold":true},{"text":" Équipes","color":"#FFFFFF"}]
scoreboard objectives add bhc.stepb.score.sb2 dummy [{"text":"Bingo Spé. ","color":"#FFFFFF"},{"text":">","color":"#00C3DF","bold":true},{"text":" Équipes","color":"#FFFFFF"}]
...
scoreboard objectives add bhc.total.score.sb1 dummy [{"text":"Total","color":"#FFE73F","bold":true}]
scoreboard objectives add bhc.total.score.sb2 dummy [{"text":"Total","color":"#FFE73F","bold":true}]

scoreboard objectives add bhc.bingo.rank.score.inv dummy
...
scoreboard objectives add bhc.bingo.rank.score dummy [{"text":"Bingos C.","color":"#FFFFFF"},{"text":" & ","color":"#FFE73F"},{"text":"Spé.","color":"#FFFFFF"}]
scoreboard objectives add bhc.bingo.rank.score.sb1 dummy [{"text":"Bingos C.","color":"#FFFFFF"},{"text":" & ","color":"#FFE73F"},{"text":"Spé.","color":"#FFFFFF"}]
scoreboard objectives add bhc.bingo.rank.score.sb2 dummy [{"text":"Bingos C.","color":"#FFFFFF"},{"text":" & ","color":"#FFE73F"},{"text":"Spé.","color":"#FFFFFF"}]
...
scoreboard objectives add bhc.stepa.rank.score.sb1 dummy [{"text":"Bingo C. ","color":"#FFFFFF"},{"text":">","color":"#DFC300","bold":true},{"text":" Score","color":"#FFFFFF"}]
scoreboard objectives add bhc.stepa.rank.score.sb2 dummy [{"text":"Bingo C. ","color":"#FFFFFF"},{"text":">","color":"#DFC300","bold":true},{"text":" Score","color":"#FFFFFF"}]
...
scoreboard objectives add bhc.bingo.rank.number dummy
...
scoreboard objectives add bhc.death.tie_break.score.inv dummy [{"text":"Survie ","color":"#FFFFFF"},{"text":">","color":"#00C3DF","bold":true},{"text":" Ticks de jeu","color":"#FFFFFF"}]
scoreboard objectives add bhc.death.tie_break.rank.number dummy
scoreboard objectives add bhc.death.tie_break.rank.score dummy
...
scoreboard objectives add bhc.total.tie_break.score dummy [{"text":"Total ","color":"#FFFFFF"},{"text":">","color":"#C300DF","bold":true},{"text":" Départage","color":"#FFFFFF"}]
scoreboard objectives add bhc.total.tie_break.rank dummy
...
scoreboard objectives add bhc.completion dummy
...
scoreboard objectives add bhc.target.dead.temp dummy
scoreboard objectives add bhc.target.team.live dummy
scoreboard objectives add bhc.target.list trigger
scoreboard objectives add bhc.target.sort dummy

scoreboard objectives add bhc.test.target_kill trigger
