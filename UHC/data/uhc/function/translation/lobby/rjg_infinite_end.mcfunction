...
execute if score @s lobby.rjg.score.sb matches ..49 run tellraw @s[scores={uhc.player.lang=061801}] [{"text":"","color":"#FFFFFF"},{"text":"[","color":"#3F3F3F","bold":true},{"text":"Jump","color":"#F3F3F3","bold":true},{"text":" Infini","color":"#FFE73F","bold":true},{"text":"]","color":"#3F3F3F","bold":true},{"text":" Score : "},{"score":{"name":"@s","objective":"lobby.rjg.score.sb"},"color":"#FFE73F"}]
...
execute if score @s lobby.rjg.score.sb matches ..49 run tellraw @s[scores={uhc.player.lang=051407}] [{"text":"","color":"#FFFFFF"},{"text":"[","color":"#3F3F3F","bold":true},{"text":"Infinite ","color":"#FFE73F","bold":true},{"text":"Jump","color":"#F3F3F3","bold":true},{"text":"]","color":"#3F3F3F","bold":true},{"text":" Score: "},{"score":{"name":"@s","objective":"lobby.rjg.score.sb"},"color":"#FFE73F"}]
