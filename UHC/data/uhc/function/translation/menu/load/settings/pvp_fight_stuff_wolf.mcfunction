...
$execute if score @s uhc.player.lang matches 061801 if score #wolf_limit uhc.data.setup matches 1 run item replace entity @s inventory.12 with minecraft:wolf_spawn_egg[minecraft:item_name=[{"text":"Limite de loups > ","color":"#E7E7E7","italic":false},{"text":"$(wolf_limit)","color":"#FF3F3F","bold":true},{"text":" par personne","color":"#3FE7FF","italic":false}],minecraft:custom_data={Tags:"settings_pvp_wolf"}]
$execute if score @s uhc.player.lang matches 061801 if score #wolf_limit uhc.data.setup matches 1 if score @s[tag=uhc.host] uhc.menu.settings.pvp matches 13 run item replace entity @s inventory.22 with minecraft:wolf_spawn_egg[minecraft:item_name=[{"text":"Limite de loups > ","color":"#E7E7E7","italic":false},{"text":"$(wolf_limit)","color":"#FF3F3F","bold":true},{"text":" par personne","color":"#3FE7FF","italic":false}],minecraft:custom_data={Tags:"settings_pvp_wolf"}]
...
$execute if score @s uhc.player.lang matches 051407 if score #wolf_limit uhc.data.setup matches 1 run item replace entity @s inventory.12 with minecraft:wolf_spawn_egg[minecraft:item_name=[{"text":"Limit of wolves > ","color":"#E7E7E7","italic":false},{"text":"$(wolf_limit)","color":"#FF3F3F","bold":true},{"text":" per person","color":"#3FE7FF","italic":false}],minecraft:custom_data={Tags:"settings_pvp_wolf"}]
$execute if score @s uhc.player.lang matches 051407 if score #wolf_limit uhc.data.setup matches 1 if score @s[tag=uhc.host] uhc.menu.settings.pvp matches 13 run item replace entity @s inventory.22 with minecraft:wolf_spawn_egg[minecraft:item_name=[{"text":"Limit of wolves > ","color":"#E7E7E7","italic":false},{"text":"$(wolf_limit)","color":"#FF3F3F","bold":true},{"text":" per person","color":"#3FE7FF","italic":false}],minecraft:custom_data={Tags:"settings_pvp_wolf"}]
