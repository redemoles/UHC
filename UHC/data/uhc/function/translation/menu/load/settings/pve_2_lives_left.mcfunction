...
$execute if score @s uhc.menu.settings.pve matches 3 if score @s uhc.player.lang matches 061801 run item replace entity @s[tag=uhc.host] inventory.22 with minecraft:yellow_candle[minecraft:item_name=[{"text":"Descente à 2 vies > ","color":"#FFFFFF","italic":false},$(2_lives_left),{"text":" minutes","color":"#FFFFFF","italic":false}],minecraft:custom_data={Tags:"settings_live_2"}]
...
$execute if score @s uhc.menu.settings.pve matches 3 if score @s uhc.player.lang matches 051407 run item replace entity @s[tag=uhc.host] inventory.22 with minecraft:yellow_candle[minecraft:item_name=[{"text":"Drop to 2 lives > ","color":"#FFFFFF","italic":false},$(2_lives_left),{"text":" minutes","color":"#FFFFFF","italic":false}],minecraft:custom_data={Tags:"settings_live_2"}]
