...
$execute if score @s uhc.player.lang matches 061801 if score @s uhc.menu.settings.pve matches 2 run item replace entity @s[tag=uhc.host] inventory.22 with minecraft:red_candle[minecraft:item_name=[{"text":"Descente à 1 vie > ","color":"#FFFFFF","italic":false},$(1_life_left),{"text":" minutes","color":"#FFFFFF","italic":false}],minecraft:custom_data={Tags:"settings_live_1"}]
...
$execute if score @s uhc.player.lang matches 051407 if score @s uhc.menu.settings.pve matches 2 run item replace entity @s[tag=uhc.host] inventory.22 with minecraft:red_candle[minecraft:item_name=[{"text":"Drop to 1 life > ","color":"#FFFFFF","italic":false},$(1_life_left),{"text":" minutes","color":"#FFFFFF","italic":false}],minecraft:custom_data={Tags:"settings_live_1"}]
