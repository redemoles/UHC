...
## FRA - Français / French
$execute if score @s uhc.menu.settings.inventory matches 01..10 if score @s uhc.player.lang matches 061801 run item replace entity @s inventory.15 with minecraft:diamond_chestplate[minecraft:item_name=[{"text":"Armures dupliquées à la mort d'un joueur : ","color":"#FFE73F","italic":false},$(item_additional_armor)],minecraft:lore=[[{"text":"• ","color":"#FF3F3F","italic":false},{"text":"Appliqué lorsqu'un joueur meurt d'un","color":"#FFFFFF"}],[{"text":"adversaire, sauf si mort définitive.","color":"#FFFFFF","italic":false}]],minecraft:tooltip_display={"hidden_components":["minecraft:attribute_modifiers"]},minecraft:custom_data={Tags:"settings_inventory_item_armor"}]
