...
## ENG - English
execute unless score #bhc bhc.scenario matches 51 if score @s uhc.player.lang matches 051407 run item replace entity @s inventory.10 with minecraft:magenta_stained_glass[minecraft:item_name=[{"text":"BHC - April Fool's Day 2026","color":"#E7E7E7","italic":false}],minecraft:custom_data={Tags:"bhc_scenario"}]

execute if score #bhc bhc.scenario matches 51 if score @s uhc.player.lang matches 051407 run item replace entity @s inventory.10 with minecraft:magenta_glazed_terracotta[minecraft:item_name=[{"text":"BHC - April Fool's Day 2026","color":"#E7E7E7","italic":false}],minecraft:custom_data={Tags:"bhc_scenario"},minecraft:lore=[[{"text":"Selected","color":"#3FE7FF","italic":false}]]]
