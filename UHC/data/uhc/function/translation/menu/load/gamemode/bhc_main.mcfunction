...
execute if score @s uhc.player.lang matches 061801 run item replace entity @s inventory.4 with minecraft:knowledge_book[minecraft:item_name=[{"text":"Lien du document","color":"#F3F3F3","italic":false}],minecraft:custom_data={Tags:"bhc_docs"}]
...
execute if score @s uhc.player.lang matches 051407 run item replace entity @s inventory.4 with minecraft:knowledge_book[minecraft:item_name=[{"text":"Document link","color":"#F3F3F3","italic":false}],minecraft:custom_data={Tags:"bhc_docs"}]
