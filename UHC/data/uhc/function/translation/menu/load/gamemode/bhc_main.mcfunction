...
execute if score #bhc uhc.gamemode matches 1 if score @s uhc.player.lang matches 061801 run item replace entity @s inventory.4 with minecraft:knowledge_book[minecraft:item_name=[{"text":"Lien du document","color":"#F3F3F3","italic":false}],minecraft:custom_data={Tags:"bhc_docs"}]
execute if score #bhc uhc.gamemode matches 1 if score @s uhc.player.lang matches 061801 run item replace entity @s inventory.6 with minecraft:chain_command_block[minecraft:item_name=[{"text":"Configuration automatique de l'UHC","color":"#3FE7FF","italic":false}],minecraft:lore=[[{"text":"Applique les paramètres recommandés de PvP,","color":"#CFCFCF"}],[{"text":"bordure, etc., pour ce scénario.","color":"#CFCFCF"}]],minecraft:custom_data={Tags:"bhc_settings"}]
execute if score #bhc uhc.gamemode matches 1 if score @s uhc.player.lang matches 061801 run item replace entity @s inventory.7 with minecraft:crafter[minecraft:item_name=[{"text":"Vérifier les grilles de bingo ","color":"#3FE7FF","italic":false},{"text":"(Onglet Advancements)","color":"#FFFFFF","italic":false}],minecraft:lore=[[{"text":"Attention : Les joueurs pourront également les voir.","color":"#CFCFCF"}]],minecraft:custom_data={Tags:"bhc_display_grid"}]
...
execute if score #bhc uhc.gamemode matches 1 if score @s uhc.player.lang matches 051407 run item replace entity @s inventory.4 with minecraft:knowledge_book[minecraft:item_name=[{"text":"Document link","color":"#F3F3F3","italic":false}],minecraft:custom_data={Tags:"bhc_docs"}]
execute if score #bhc uhc.gamemode matches 1 if score @s uhc.player.lang matches 051407 run item replace entity @s inventory.6 with minecraft:chain_command_block[minecraft:item_name=[{"text":"Automatic setup of the UHC","color":"#3FE7FF","italic":false}],minecraft:lore=[[{"text":"Set the recommended settings for PvP,","color":"#CFCFCF"}],[{"text":"border, etc., for this scenario.","color":"#CFCFCF"}]],minecraft:custom_data={Tags:"bhc_settings"}]
execute if score #bhc uhc.gamemode matches 1 if score @s uhc.player.lang matches 051407 run item replace entity @s inventory.7 with minecraft:crafter[minecraft:item_name=[{"text":"Check the bingo grids ","color":"#3FE7FF","italic":false},{"text":"(Advancements tab)","color":"#FFFFFF","italic":false}],minecraft:lore=[[{"text":"Note: Players will also be able to see them.","color":"#CFCFCF"}]],minecraft:custom_data={Tags:"bhc_display_grid"}]
