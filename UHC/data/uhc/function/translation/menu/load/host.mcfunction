...
#> uhc:translation/menu/load/host
#
# @within			uhc:pre_game/menu/load/main/host/menu
#
#
#
#
...
execute if score @s uhc.player.lang matches 051407 run item replace entity @s inventory.6 with minecraft:repeating_command_block[minecraft:item_name=[{"text":"Scenarios","color":"#FFE73F","italic":false}],minecraft:custom_data={Tags:"menu_scenario"}]
execute if score @s uhc.player.lang matches 051407 run item replace entity @s inventory.7 with minecraft:chain_command_block[minecraft:item_name=[{"text":"Settings","color":"#3FE7FF","italic":false}],minecraft:custom_data={Tags:"menu_settings"}]
