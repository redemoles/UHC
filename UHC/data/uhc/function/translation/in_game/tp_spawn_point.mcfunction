...
$execute if score #minutes uhc.data.temp matches -1 if score #lives uhc.data.setup matches 1.. if score @s uhc.player.lang matches 061801 run tellraw @s [{"text":"Point de réapparition : ","color":"#FFFFFF"},{"text":"$(x) $(z)","color":"#FFE73F","bold":true}]
...
$execute if score #minutes uhc.data.temp matches -1 if score #lives uhc.data.setup matches 1.. if score @s uhc.player.lang matches 051407 run tellraw @s [{"text":"Respawn point: ","color":"#FFFFFF"},{"text":"$(x) $(z)","color":"#FFE73F","bold":true}]
