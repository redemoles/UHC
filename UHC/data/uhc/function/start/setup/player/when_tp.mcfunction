...
execute unless score #start_in_sky uhc.data.setup matches 1 run scoreboard players set #tick_start uhc.data.temp 100
...
execute if score #start_in_sky uhc.data.setup matches 1 as @s[tag=uhc.player] run function uhc:in_game/tp/spawn/point/macro_set
execute if score #start_in_sky uhc.data.setup matches 1 run scoreboard players set #tick_start uhc.data.temp 100
# Spectateurs
