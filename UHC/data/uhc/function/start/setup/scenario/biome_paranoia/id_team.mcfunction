...
#> uhc:start/setup/scenario/biome_paranoia/id_team
#
# @within			uhc:start/setup/scenario/biome_paranoia/root
#
#
...
function uhc:start/setup/scenario/biome_paranoia/create_team with storage uhc:biome_paranoia biome_paranoia
