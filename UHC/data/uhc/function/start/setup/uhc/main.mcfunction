...
## Mode de jeu
execute if score #bhc uhc.gamemode matches 1 in uhc:lobby run function bhc:start/main
function #plugin:start/main
...
scoreboard players operation #3_lives_left uhc.data.temp = #3_lives_left uhc.data.setup
scoreboard players operation #2_lives_left uhc.data.temp = #2_lives_left uhc.data.setup
scoreboard players operation #1_life_left uhc.data.temp = #1_life_left uhc.data.setup
...
execute if score #sky_high uhc.scenario matches 1 run scoreboard players set #map_height_limit_above uhc.data.temp 256
...
scoreboard objectives add uhc.player.damage_taken.total dummy [{"text":" [Dégâts reçus total]*10","color":"#FFFFFF"}]
scoreboard objectives add uhc.player.damage_taken.pve dummy [{"text":" [Dégâts reçus PvE]*10","color":"#FFFFFF"}]
scoreboard objectives add uhc.player.damage_taken.pvp dummy [{"text":" [Dégâts reçus PvP]*10","color":"#FFFFFF"}]
...
function uhc:in_game/timer/second
