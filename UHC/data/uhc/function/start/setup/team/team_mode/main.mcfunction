...
#> uhc:start/setup/team/team_mode/main
#
...
## Id Joueurs
execute as @a[tag=uhc.player] run function uhc:start/setup/team/team_mode/id_player
...
execute as @e[type=minecraft:marker,tag=uhc.inactive,distance=0..] run function uhc:start/setup/team/team_mode/marker/id
