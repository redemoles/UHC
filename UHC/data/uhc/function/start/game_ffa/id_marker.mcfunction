...
execute in uhc:lobby if score #team uhc.id.team matches ..9 run data modify block 0 -61 0 front_text.messages[1] set value [{"text":"0","color":"#FF3F3F","bold":true},{"score":{"name":"@s","objective":"uhc.id.team"}}]
execute in uhc:lobby if score #team uhc.id.team matches 10.. run data modify block 0 -61 0 front_text.messages[1] set value [{"score":{"name":"@s","objective":"uhc.id.team"},"color":"#FF3F3F","bold":true}]
