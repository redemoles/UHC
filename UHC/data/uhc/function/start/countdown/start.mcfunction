...
execute as @a[scores={uhc.player.tp=1}] run function uhc:start/tp/1_tick_later
...
execute if score #tick_start uhc.data.temp matches 100 in uhc:lobby run function uhc:start/tp/main
