...
#> uhc:in_game/scenario/sound_paranoia/trigger
#
...
execute as @s[predicate=uhc:dimension/overworld,scores={uhc.scenario.sound_paranoia.sound=1}] run function uhc:in_game/scenario/sound_paranoia/sound/creeper
execute as @s[predicate=uhc:dimension/the_nether,scores={uhc.scenario.sound_paranoia.sound=1}] run function uhc:in_game/scenario/sound_paranoia/sound/ghast
execute as @s[predicate=uhc:dimension/overworld,scores={uhc.scenario.sound_paranoia.sound=2}] run function uhc:in_game/scenario/sound_paranoia/sound/zombie
execute as @s[predicate=uhc:dimension/the_nether,scores={uhc.scenario.sound_paranoia.sound=2}] run function uhc:in_game/scenario/sound_paranoia/sound/piglin_brute
execute as @s[scores={uhc.scenario.sound_paranoia.sound=3}] run function uhc:in_game/scenario/sound_paranoia/long_sound/player_eat
execute as @s[scores={uhc.scenario.sound_paranoia.sound=4}] run function uhc:in_game/scenario/sound_paranoia/long_sound/skeleton
