...
execute if score #tier_2_damage uhc.scenario.blood_diamond.setup matches 1.. if score #random uhc.scenario.blood_diamond.temp <= #random_damage_gold_ingot uhc.scenario.blood_diamond.temp at @s run damage @s 1 minecraft:mob_attack by @n[type=minecraft:marker,tag=uhc.scenario.blood_diamond]
...
execute if score #tier_2_diamond uhc.scenario.blood_diamond.setup matches 1.. if score #random uhc.scenario.blood_diamond.temp > #random_gold_ingot_diamond uhc.scenario.blood_diamond.temp if score #random uhc.scenario.blood_diamond.temp <= #random_diamond_gift uhc.scenario.blood_diamond.temp run give @s minecraft:emerald 1
execute if score #tier_2_diamond uhc.scenario.blood_diamond.setup matches 1.. if score #random uhc.scenario.blood_diamond.temp > #random_gold_ingot_diamond uhc.scenario.blood_diamond.temp if score #random uhc.scenario.blood_diamond.temp <= #random_diamond_gift uhc.scenario.blood_diamond.temp if score #double_ores uhc.scenario matches 1 run give @s minecraft:emerald 1
execute if score #tier_2_gift uhc.scenario.blood_diamond.setup matches 1.. if score #random uhc.scenario.blood_diamond.temp > #random_diamond_gift uhc.scenario.blood_diamond.temp run give @p[tag=uhc.blood_diamond.receive] minecraft:emerald
...
function uhc:translation/in_game/scenario/blood_diamond_trade_uhc_step_mid with storage uhc:scenario blood_diamond
