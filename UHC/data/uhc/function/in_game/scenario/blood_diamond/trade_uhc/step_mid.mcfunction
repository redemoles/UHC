...
execute if score #tier_2_diamond uhc.scenario.blood_diamond.setup matches 1.. if score #random uhc.scenario.blood_diamond.temp > #random_gold_ingot_diamond uhc.scenario.blood_diamond.temp if score #random uhc.scenario.blood_diamond.temp <= #random_diamond_gift uhc.scenario.blood_diamond.temp run function uhc:in_game/player/misc/ore_mined/emerald_main
