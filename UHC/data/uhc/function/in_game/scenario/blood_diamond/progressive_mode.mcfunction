...
$execute if score #trade_uhc uhc.scenario matches 0 if score @s uhc.scenario.blood_diamond.mined matches 1..$(end_tier_1) run function uhc:in_game/scenario/blood_diamond/step_safe
...
$execute if score #trade_uhc uhc.scenario matches 0 if score @s uhc.scenario.blood_diamond.mined matches $(start_tier_3).. run function uhc:in_game/scenario/blood_diamond/step_damage

$execute if score #trade_uhc uhc.scenario matches 1 if score @s uhc.scenario.blood_diamond.mined matches 1..$(end_tier_1) run function uhc:in_game/scenario/blood_diamond/trade_uhc/step_safe
...
$execute if score #trade_uhc uhc.scenario matches 1 if score @s uhc.scenario.blood_diamond.mined matches $(start_tier_3).. run function uhc:in_game/scenario/blood_diamond/trade_uhc/step_damage
