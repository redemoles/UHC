...
execute if score #random uhc.scenario.blood_diamond.temp > #random_gold_ingot_diamond uhc.scenario.blood_diamond.temp if score #random uhc.scenario.blood_diamond.temp <= #random_diamond_gift uhc.scenario.blood_diamond.temp run give @s minecraft:diamond 1
execute if score #random uhc.scenario.blood_diamond.temp > #random_gold_ingot_diamond uhc.scenario.blood_diamond.temp if score #random uhc.scenario.blood_diamond.temp <= #random_diamond_gift uhc.scenario.blood_diamond.temp if score #double_ores uhc.scenario matches 1 run give @s minecraft:diamond 1
execute if score #random uhc.scenario.blood_diamond.temp > #random_diamond_gift uhc.scenario.blood_diamond.temp run give @p[tag=uhc.blood_diamond.receive] minecraft:diamond
