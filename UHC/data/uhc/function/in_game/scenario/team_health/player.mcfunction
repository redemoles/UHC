...
# Coeurs
execute if score #hp_tab uhc.data.setup matches 3 store result score #count uhc.scenario.team_health.team if entity @a[predicate=uhc:id/team,gamemode=!spectator]
