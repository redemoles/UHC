...
# Msg FRA
tellraw @s[scores={uhc.player.lang=061801}] [{"text":"Vous venez de récupérer un coeur !","color":"#FFE73F"}]

# Msg ENG
tellraw @s[scores={uhc.player.lang=051407}] [{"text":"You just gain one heart !","color":"#FFE73F"}]
