...
execute store result storage uhc:temp map_height.temp int 1 run data get entity @s Pos[1]
execute store result score #temp_y uhc.data.temp run data get storage uhc:temp map_height.temp
