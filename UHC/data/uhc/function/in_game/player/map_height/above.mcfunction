...
#> uhc:in_game/player/map_height/above
#
# @within			uhc:in_game/player/map_height/check_limit
#
#
# @description		Le joueur est au-dessus des limites acceptés
#
...
execute if score @s uhc.player.map_height.effect >= #map_height_tick_above uhc.data.setup run damage @s 1
execute if score @s uhc.player.map_height.effect >= #map_height_tick_above uhc.data.setup run effect give @s minecraft:glowing 2 0 true
execute if score @s uhc.player.map_height.effect >= #map_height_tick_above uhc.data.setup run scoreboard players remove @s uhc.player.map_height.effect 2
