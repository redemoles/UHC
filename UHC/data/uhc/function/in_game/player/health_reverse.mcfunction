...
#> uhc:in_game/player/health_reverse
#
# @within			uhc:in_game/player/health
#
#
...
execute if score #team_health uhc.scenario matches 1 as @n[type=marker,tag=UHC,distance=0..,predicate=uhc:id/team] run scoreboard players operation #temp uhc.data.temp *= @s uhc.player.lives
