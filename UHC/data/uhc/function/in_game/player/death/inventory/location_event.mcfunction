...
#> uhc:in_game/player/death/inventory/location_event
#
# @within			uhc:in_game/player/death/inventory/location_set
#
#
# @description		
#
...
# Mort définitive
$execute if score @s uhc.player.lives matches ..0 in $(dim) positioned $(x) $(y) $(z) if data storage uhc:temp Inventory[0] run function uhc:in_game/player/death/inventory/item_inventory
