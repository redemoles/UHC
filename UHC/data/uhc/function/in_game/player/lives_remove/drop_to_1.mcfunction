...
# Title
execute if score #live_1 uhc.data.temp matches ..0 as @a[scores={uhc.player.lives=2},predicate=uhc:id/team] run title @s times 0s 1.5s 0.5s
execute if score #live_1 uhc.data.temp matches ..0 as @a[scores={uhc.player.lives=2},predicate=uhc:id/team] run title @s title [{"text":" ","color":"#FFE73F","bold":false}]
execute if score #live_1 uhc.data.temp matches ..0 as @a[scores={uhc.player.lives=2},predicate=uhc:id/team] run title @s subtitle [{"text":"❤❤ ","color":"#FFE73F","bold":false},{"text":"→","color":"#FFFFFF","bold":false},{"text":" ❤","color":"#E73F3F","bold":false}]
execute if score #live_1 uhc.data.temp matches ..0 as @a[scores={uhc.player.lives=2},predicate=uhc:id/team] at @s run playsound minecraft:block.note_block.pling master @s ~ ~ ~ 0.5 1 0.5
