...
execute as @a[scores={uhc.player.lives=4..},predicate=uhc:id/team] run function uhc:in_game/player/misc/team_join/known_team
...
# Couleur du joueur
execute as @a[scores={uhc.player.lives=4..},predicate=uhc:id/team] run function uhc:in_game/player/misc/team_join/main

## Récompense
execute as @a[scores={uhc.player.lives=4..},predicate=uhc:id/team] at @s run function uhc:in_game/player/lives_remove/compensation_1
# Bingo UHC
