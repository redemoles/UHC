...
# PvP Version 1.8
execute if score #version_pvp uhc.data.setup matches 1 run function uhc:in_game/player/pvp/settings/version_pvp/old_pvp
execute if score #version_pvp uhc.data.setup matches 0 if entity @s[tag=uhc.version_pvp.1_8] run function uhc:in_game/player/pvp/settings/version_pvp/actual_pvp
