...
# Bingo UHC
execute if score #bhc uhc.gamemode matches 1 if entity @p[tag=uhc.temp.attacked,predicate=!uhc:id/team] as @e[type=minecraft:marker,tag=UHC,distance=0..,predicate=uhc:id/team] run function bhc:scores_calculator/kills/damage/attacker_team
