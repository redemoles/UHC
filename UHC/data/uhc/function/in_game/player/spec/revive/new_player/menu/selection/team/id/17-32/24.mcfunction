...
#> uhc:in_game/player/spec/revive/new_player/menu/selection/team/id/17-32/24
#
...
execute store result score #temp uhc.data.setup run scoreboard players get @n[type=minecraft:marker,tag=UHC,distance=0..,scores={uhc.id.team=24}] uhc.team.size
...
tellraw @s[scores={uhc.player.lang=061801}] [{"text":"\nClique sur ce message pour rejoindre l'","color":"#FFFFFF","click_event":{"action":"run_command","command":"trigger uhc.menu.revive set 24"}},{"text":"♦ Équipe Orange","color":"gold"}]
tellraw @s[scores={uhc.player.lang=051407}] [{"text":"\nClick on this message to join the ","color":"#FFFFFF","click_event":{"action":"run_command","command":"trigger uhc.menu.revive set 24"}},{"text":"♦ Orange Team","color":"gold"}]
