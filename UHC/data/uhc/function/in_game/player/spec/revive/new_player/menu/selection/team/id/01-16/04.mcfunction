...
#> uhc:in_game/player/spec/revive/new_player/menu/selection/team/id/01-16/04
#
...
execute store result score #temp uhc.data.setup run scoreboard players get @n[type=minecraft:marker,tag=UHC,distance=0..,scores={uhc.id.team=04}] uhc.team.size
...
tellraw @s[scores={uhc.player.lang=061801}] [{"text":"\nClique sur ce message pour rejoindre l'","color":"#FFFFFF","click_event":{"action":"run_command","command":"trigger uhc.menu.revive set 04"}},{"text":"Équipe Cyan","color":"aqua"}]
tellraw @s[scores={uhc.player.lang=051407}] [{"text":"\nClick on this message to join the ","color":"#FFFFFF","click_event":{"action":"run_command","command":"trigger uhc.menu.revive set 04"}},{"text":"Cyan Team","color":"aqua"}]
