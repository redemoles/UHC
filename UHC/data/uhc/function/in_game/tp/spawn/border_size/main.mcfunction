...
execute if score #border_size uhc.data.temp matches 1000..2000 unless score #border_size_tp uhc.data.temp matches 1000 in uhc:lobby as @e[type=minecraft:marker,tag=UHC,distance=0..] run function uhc:in_game/tp/spawn/border_size/1000-1999
