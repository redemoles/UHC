...
# Fire Aspect / Flame
execute if score #fire_flame uhc.data.setup matches 0 if items entity @s weapon.mainhand *[minecraft:enchantments~[{"enchantments":"minecraft:fire_aspect"}]] run item modify entity @s weapon.mainhand {"type":"minecraft:set_enchantments","enchantments":{"minecraft:fire_aspect":-255},add:true}
execute if score #fire_flame uhc.data.setup matches 0 if items entity @s weapon.mainhand *[minecraft:enchantments~[{"enchantments":"minecraft:flame"}]] run item modify entity @s weapon.mainhand {"type":"minecraft:set_enchantments","enchantments":{"minecraft:flame":-255},add:true}
execute if score #fire_flame uhc.data.setup matches 0 if items entity @s weapon.offhand *[minecraft:enchantments~[{"enchantments":"minecraft:fire_aspect"}]] run item modify entity @s weapon.offhand {"type":"minecraft:set_enchantments",enchantments:{"minecraft:fire_aspect":-255},add:true}
execute if score #fire_flame uhc.data.setup matches 0 if items entity @s weapon.offhand *[minecraft:enchantments~[{"enchantments":"minecraft:flame"}]] run item modify entity @s weapon.offhand {"type":"minecraft:set_enchantments","enchantments":{"minecraft:flame":-255},add:true}
