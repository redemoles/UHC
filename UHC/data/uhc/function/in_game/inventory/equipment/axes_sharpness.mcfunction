...
$execute if items entity @s weapon.mainhand minecraft:copper_axe[minecraft:enchantments~[{"enchantments":"minecraft:sharpness","levels":{"min":$(max_plus_1)}}]] run item modify entity @s weapon.mainhand {"function":"minecraft:set_enchantments","enchantments":{"minecraft:sharpness":$(max)}}
