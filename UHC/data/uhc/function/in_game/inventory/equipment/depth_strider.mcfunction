...
$execute if items entity @s armor.feet minecraft:copper_boots[minecraft:enchantments~[{"enchantments":"minecraft:depth_strider","levels":{"min":$(max_plus_1)}}]] run item modify entity @s armor.feet {"function":"minecraft:set_enchantments","enchantments":{"minecraft:depth_strider":$(max)}}
