...
#> uhc:in_game/advancement/eat_a_regeneration_stew/tellraw_heart
#
...
function uhc:translation/in_game/advancement_eat_a_regeneration_stew_heart with storage uhc:temp hp
