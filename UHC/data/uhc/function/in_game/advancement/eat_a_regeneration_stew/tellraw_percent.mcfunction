...
#> uhc:in_game/advancement/eat_a_regeneration_stew/tellraw_percent
#
# @within			uhc:in_game/advancement/eat_a_regeneration_stew/
#
#
...
function uhc:translation/in_game/advancement_eat_a_regeneration_stew_percent with storage uhc:temp hp
