...
execute if score #live_3 uhc.data.setup matches 1.. if score #live_3 uhc.data.temp matches 0 run scoreboard players set #lives uhc.data.temp 3
execute if score #live_2 uhc.data.setup matches 1.. if score #live_2 uhc.data.temp matches 0 run scoreboard players set #lives uhc.data.temp 2
execute if score #live_1 uhc.data.setup matches 1.. if score #live_1 uhc.data.temp matches 0 run scoreboard players set #lives uhc.data.temp 1
