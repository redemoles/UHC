...
#> uhc:in_game/timer/border/dynamic/shrink_2
#
# @within			uhc:in_game/timer/border/shrink/2
#
#
...
scoreboard players operation #shrink_2_length uhc.data.temp = #border_size uhc.data.temp
scoreboard players operation #shrink_2_length uhc.data.temp -= #shrink_2_size_end uhc.data.temp
execute if score #border_size uhc.data.temp matches ..256 run scoreboard players operation #shrink_2_length uhc.data.temp *= #02 uhc.data.numbers
