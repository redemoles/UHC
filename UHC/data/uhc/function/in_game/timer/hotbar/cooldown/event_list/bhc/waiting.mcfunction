...
execute if score #bhc bhc.scenario matches 51 if score #stepa_end bhc.data.temp matches 0.. run return run function uhc:in_game/timer/hotbar/cooldown/event_list/bhc/step_a/51/waiting
