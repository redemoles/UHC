...
#> uhc:in_game/timer/hotbar/cooldown/event_list/bhc/step_a/51/waiting
#
...
execute if score #stepa_start bhc.data.temp = #min_cooldown_temp uhc.data.temp run data modify storage uhc:temp hotbar.alert_fra append value [{"text":"début du ","color":"#FFFFFF"}, {"text":"A euqissalC ogniB","color":"#B73FFF"}]
execute if score #stepa_start bhc.data.temp = #min_cooldown_temp uhc.data.temp run data modify storage uhc:temp hotbar.alert_eng append value [{"text":"start of the ","color":"#FFFFFF"}, {"text":"A ogniB cissalC","color":"#B73FFF"}]
...
execute if score #stepa_end bhc.data.temp = #min_cooldown_temp uhc.data.temp run data modify storage uhc:temp hotbar.alert_fra append value [{"text":"fin du ","color":"#FFFFFF"}, {"text":"A euqissalC ogniB","color":"#B73FFF"}]
execute if score #stepa_end bhc.data.temp = #min_cooldown_temp uhc.data.temp run data modify storage uhc:temp hotbar.alert_eng append value [{"text":"end of the ","color":"#FFFFFF"}, {"text":"A ogniB cissalC","color":"#B73FFF"}]
