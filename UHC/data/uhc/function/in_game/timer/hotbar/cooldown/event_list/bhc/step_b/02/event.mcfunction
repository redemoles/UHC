...
#> uhc:in_game/timer/hotbar/cooldown/event_list/bhc/step_b/02/event
#
# @within			uhc:in_game/timer/hotbar/cooldown/event_list/bhc/event
#
#
...
execute if score #stepb_end bhc.data.temp = #min_cooldown_temp uhc.data.temp run data modify storage uhc:temp hotbar.alert_fra append value [{"text":"Fin du ","color":"#FFFFFF"}, {"text":"Bingo de l'Ère Viking","color":"#CF6F3F"}]
execute if score #stepb_end bhc.data.temp = #min_cooldown_temp uhc.data.temp run data modify storage uhc:temp hotbar.alert_eng append value [{"text":"End of the","color":"#FFFFFF"}, {"text":"Bingo of the Viking Era","color":"#CF6F3F"}]
