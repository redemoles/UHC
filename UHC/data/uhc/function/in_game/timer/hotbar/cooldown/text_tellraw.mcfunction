...
execute if score #bhc uhc.gamemode matches 1 run function bhc:in_game/timer/countdown/text_tellraw
...
execute if score #bhc bhc.scenario matches 99 if score #shrink_1_time_left uhc.data.temp matches 0..5 run function bhc:in_game/timer/countdown/bhc_run
