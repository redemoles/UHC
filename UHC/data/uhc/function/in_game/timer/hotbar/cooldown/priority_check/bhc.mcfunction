...
# Ruée vers l'Or
execute if score #bhc bhc.scenario matches 01 if score #stepb_exhaustion bhc.data.temp = #min_cooldown_temp uhc.data.temp run scoreboard players add #min_cooldown_alert uhc.data.temp 1
