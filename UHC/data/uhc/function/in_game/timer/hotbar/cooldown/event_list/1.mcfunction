...
execute if score #shrink_1_time_left uhc.data.temp = #min_cooldown_temp uhc.data.temp run data modify storage uhc:temp hotbar.alert_fra append value [{"text":"de la ","color":"#FFFFFF"}, {"text":"réduction","color":"#FF3F3F"}]
execute if score #shrink_1_time_left uhc.data.temp = #min_cooldown_temp uhc.data.temp run data modify storage uhc:temp hotbar.alert_eng append value [{"text":"of the ","color":"#FFFFFF"}, {"text":"shrinkage","color":"#FF3F3F"}]
