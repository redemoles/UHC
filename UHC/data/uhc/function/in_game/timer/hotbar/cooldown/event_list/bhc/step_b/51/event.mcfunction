...
#> uhc:in_game/timer/hotbar/cooldown/event_list/bhc/step_b/51/event
#
...
execute if score #stepb_start bhc.data.temp = #min_cooldown_temp uhc.data.temp run data modify storage uhc:temp hotbar.alert_fra append value [{"text":"Début du ","color":"#FFFFFF"}, {"text":"euqissalC ogniB B","color":"#B73FFF"}]
execute if score #stepb_start bhc.data.temp = #min_cooldown_temp uhc.data.temp run data modify storage uhc:temp hotbar.alert_eng append value [{"text":"Start of the ","color":"#FFFFFF"}, {"text":"ogniB cissalC B","color":"#B73FFF"}]
...
execute if score #stepb_end bhc.data.temp = #min_cooldown_temp uhc.data.temp run data modify storage uhc:temp hotbar.alert_fra append value [{"text":"Fin du ","color":"#FFFFFF"}, {"text":"euqissalC ogniB B","color":"#B73FFF"}]
execute if score #stepb_end bhc.data.temp = #min_cooldown_temp uhc.data.temp run data modify storage uhc:temp hotbar.alert_eng append value [{"text":"End of the ","color":"#FFFFFF"}, {"text":"ogniB cissalC B","color":"#B73FFF"}]
