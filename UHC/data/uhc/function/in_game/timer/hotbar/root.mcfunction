...
execute unless score #hotbar_cooldown uhc.data.temp matches 1.. if score #bhc uhc.gamemode matches 1 if score #tick uhc.data.temp matches 0.. run function bhc:in_game/timer/hotbar
execute unless score #hotbar_cooldown uhc.data.temp matches 1.. if score #tick uhc.data.temp matches 0.. run function #plugin:in_game/timer/hotbar with storage uhc:temp hotbar
