...
#> uhc:pre_game/menu/selected/start
#
...
execute unless items entity @s[tag=uhc.menu.start] inventory.12 *[minecraft:custom_data={Tags:"start"}] run return run function uhc:start/main
