...
#> uhc:pre_game/menu/selected/main/player/team/chosen/01-16/04
#
...
execute store result score #temp uhc.data.setup if entity @a[scores={uhc.id.team=04}]
...
scoreboard players set @s uhc.id.team 04
...
function uhc:translation/menu/load/team/page/team_join/01-16/04
