...
#> uhc:pre_game/menu/selected/main/host/config
#
...
execute if score #diamond_limit uhc.scenario matches 1 run tellraw @s [{"text":"• ","color":"#3F9FFF","bold":true},{"text":"Diamond Limit","color":"#FFFFFF","bold":false}]
...
execute if score #gold_limit uhc.scenario matches 1 run tellraw @s [{"text":"• ","color":"#3F9FFF","bold":true},{"text":"Gold Limit","color":"#FFFFFF","bold":false}]
