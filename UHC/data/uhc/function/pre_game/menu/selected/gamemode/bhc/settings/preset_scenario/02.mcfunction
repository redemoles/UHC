...
#> uhc:pre_game/menu/selected/gamemode/bhc/settings/preset_scenario/02
#
...
execute if score #biome_paranoia uhc.scenario matches 0 run function uhc:pre_game/menu/selected/scenario/list/biome_paranoia
