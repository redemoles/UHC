...
#> uhc:pre_game/menu/selected/gamemode/bhc/settings/main
#
...
execute if score @s uhc.menu.gamemode.bhc matches 12.. unless items entity @s inventory.20 *[minecraft:custom_data={Tags:"-10"}] run function uhc:pre_game/menu/selected/gamemode/bhc/settings/1_remove
execute if score @s uhc.menu.gamemode.bhc matches 12.. unless items entity @s inventory.21 *[minecraft:custom_data={Tags:"-1"}] run function uhc:pre_game/menu/selected/gamemode/bhc/settings/2_remove
execute if score @s uhc.menu.gamemode.bhc matches 12.. unless items entity @s inventory.23 *[minecraft:custom_data={Tags:"+1"}] run function uhc:pre_game/menu/selected/gamemode/bhc/settings/3_add
execute if score @s uhc.menu.gamemode.bhc matches 12.. unless items entity @s inventory.24 *[minecraft:custom_data={Tags:"+10"}] run function uhc:pre_game/menu/selected/gamemode/bhc/settings/4_add
