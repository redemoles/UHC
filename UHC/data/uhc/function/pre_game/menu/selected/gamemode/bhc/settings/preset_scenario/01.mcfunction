...
#> uhc:pre_game/menu/selected/gamemode/bhc/settings/preset_scenario/01
#
# @within			uhc:pre_game/menu/load/gamemode_bhc/
#
#
# @description		Paramètres prédéfinis pour BHC I - Ruée Vers l'Or
#
...
execute unless score #double_ores uhc.scenario matches 0 run function uhc:pre_game/menu/selected/scenario/list/double_ores
