...
execute if score @s uhc.menu.scenario.blood_diamond matches 13.. unless items entity @s inventory.2 *[minecraft:custom_data={Tags:"scenario_blood_diamond_tier_2"}] run scoreboard players set @s uhc.menu.scenario.blood_diamond 12
