...
#> uhc:pre_game/menu/selected/scenario/list/enchanting_setup/main
#
...
execute unless items entity @s inventory.1 *[minecraft:custom_data={Tags:"enchanting_setup"}] run function uhc:pre_game/menu/selected/scenario/list/enchanting_setup/100
