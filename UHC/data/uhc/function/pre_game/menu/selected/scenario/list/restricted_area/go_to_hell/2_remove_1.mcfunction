...
#> uhc:pre_game/menu/selection/scenario/list/restricted_area/go_to_hell/2_remove_1
#
...
# Timer Go To Hell
execute if score @s uhc.menu.scenario.restricted_area matches 3 if score #go_to_hell uhc.data.setup matches 1.. run scoreboard players remove #go_to_hell uhc.data.setup 1
