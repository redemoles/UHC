...
execute if score @s uhc.menu.settings.inventory matches 31..40 unless items entity @s inventory.11 *[minecraft:custom_data={Tags:"settings_inventory_items_diamond_armor"}] run function uhc:pre_game/menu/load/settings/inventory/items_authorization/diamond_armor/apply_change
execute if score @s uhc.menu.settings.inventory matches 31..40 unless items entity @s inventory.12 *[minecraft:custom_data={Tags:"settings_inventory_items_netherite_armor"}] run function uhc:pre_game/menu/load/settings/inventory/items_authorization/netherite_armor/apply_change
