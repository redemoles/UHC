...
#> uhc:pre_game/menu/selected/settings/pvp/absorption/menu
#
...
execute unless items entity @s inventory.3 *[minecraft:custom_data={Tags:"settings_pvp_no_clean"}] run function uhc:pre_game/menu/selected/settings/pvp/no_clean/preset_menu
