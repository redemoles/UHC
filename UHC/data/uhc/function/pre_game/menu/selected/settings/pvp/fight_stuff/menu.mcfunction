...
execute unless items entity @s[tag=uhc.host] inventory.3 *[minecraft:custom_data={Tags:"settings_pvp_no_clean"}] run return run function uhc:pre_game/menu/selected/settings/pvp/no_clean/preset_menu
execute unless items entity @s[tag=uhc.host] inventory.4 *[minecraft:custom_data={Tags:"settings_absorption"}] run function uhc:pre_game/menu/selected/settings/pvp/absorption/preset_menu

execute unless items entity @s[tag=uhc.host] inventory.10 *[minecraft:custom_data={Tags:"settings_pvp_shield"}] run function uhc:pre_game/menu/selected/settings/pvp/fight_stuff/shield
execute unless items entity @s[tag=uhc.host] inventory.11 *[minecraft:custom_data={Tags:"settings_pvp_horse"}] run function uhc:pre_game/menu/selected/settings/pvp/fight_stuff/horse
execute if score @s[tag=uhc.host] uhc.menu.settings.pvp matches 13 unless items entity @s inventory.22 *[minecraft:custom_data={Tags:"settings_pvp_wolf"}] run function uhc:pre_game/menu/selected/settings/pvp/fight_stuff/wolf_limit_number
execute unless items entity @s[tag=uhc.host] inventory.12 *[minecraft:custom_data={Tags:"settings_pvp_wolf"}] run function uhc:pre_game/menu/selected/settings/pvp/fight_stuff/wolf_limit_number
execute unless items entity @s[tag=uhc.host] inventory.13 *[minecraft:custom_data={Tags:"settings_pvp_wolf"}] run function uhc:pre_game/menu/selected/settings/pvp/fight_stuff/wolf_armor
