...
#> uhc:pre_game/menu/selection/settings/team/host
#
...
execute if score #random_team uhc.data.setup matches 1.. unless items entity @s inventory.12 *[minecraft:custom_data={Tags:"pots_number"}] run return run function uhc:pre_game/menu/load/settings/team/pots_number
execute if score #random_team uhc.data.setup matches 1.. unless items entity @s inventory.13 *[minecraft:custom_data={Tags:"random_team_instant"}] run return run function uhc:pre_game/menu/load/settings/team/random_now_instant
