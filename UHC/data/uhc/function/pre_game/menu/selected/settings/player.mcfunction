...
#> uhc:pre_game/menu/selected/settings/player
#
...
execute if score @s uhc.menu.settings.pvp matches 1.. unless items entity @s inventory.11 *[minecraft:custom_data={Tags:"settings_pvp_fight_stuff"}] run function uhc:pre_game/menu/selected/settings/pvp/fight_stuff/preset_menu
...
execute if score @s uhc.menu.settings.border matches 1..10 unless items entity @s inventory.10 *[minecraft:custom_data={Tags:"settings_border"}] run return run function uhc:pre_game/menu/selected/settings/border/shrink/preset_menu/shrink_1
execute if score @s uhc.menu.settings.border matches 1..10 unless score #shrink_dynamic uhc.data.setup matches 1 unless items entity @s inventory.11 *[minecraft:custom_data={Tags:"settings_border"}] run return run function uhc:pre_game/menu/selected/settings/border/shrink/preset_menu/shrink_2
execute if score @s uhc.menu.settings.border matches 1..10 unless score #shrink_dynamic uhc.data.setup matches 1..2 unless items entity @s inventory.12 *[minecraft:custom_data={Tags:"settings_border"}] run return run function uhc:pre_game/menu/selected/settings/border/shrink/preset_menu/shrink_3
execute if score @s uhc.menu.settings.border matches 1..10 unless items entity @s inventory.13 *[minecraft:custom_data={Tags:"settings_border"}] run return run function uhc:pre_game/menu/selected/settings/border/shrink/preset_menu/shrink_height
...
execute if score @s uhc.menu.settings.misc matches 1.. unless items entity @s inventory.11 *[minecraft:custom_data={Tags:"settings_misc_health_display"}] run function uhc:pre_game/menu/selected/settings/misc/health_display/preset_menu
execute if score @s uhc.menu.settings.misc matches 1.. unless items entity @s inventory.12 *[minecraft:custom_data={Tags:"settings_misc_team_stuff"}] run function uhc:pre_game/menu/selected/settings/misc/team_stuff/preset_menu
execute if score @s uhc.menu.settings.inventory matches 1.. unless items entity @s inventory.24 *[minecraft:custom_data={Tags:"settings_inventory_pages"}] run function uhc:pre_game/menu/selected/settings/inventory/pages/preset_menu
