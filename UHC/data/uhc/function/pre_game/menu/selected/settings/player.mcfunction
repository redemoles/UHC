...
execute if score @s uhc.menu.settings matches 1.. unless items entity @s inventory.2 *[minecraft:custom_data={Tags:"settings_lives"}] run return run function uhc:pre_game/menu/selection/settings/pve/preset_menu
...
execute if score @s uhc.menu.settings.border matches 1..10 unless items entity @s inventory.13 *[minecraft:custom_data={Tags:"settings_border"}] run return run function uhc:pre_game/menu/load/settings/border/shrink_height/preset_menu
...
execute if score @s uhc.menu.settings matches 1.. unless items entity @s inventory.6 *[minecraft:custom_data={Tags:"settings_potion"}] run return run function uhc:pre_game/menu/selection/settings/potion/preset_menu
execute if score @s uhc.menu.settings matches 1.. unless items entity @s inventory.7 *[minecraft:custom_data={Tags:"settings_misc"}] run return run function uhc:pre_game/menu/selection/settings/misc/preset_menu
