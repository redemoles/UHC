...
#> uhc:pre_game/menu/selection/settings/misc/team_stuff/main
#
...
execute unless items entity @s inventory.2 *[minecraft:custom_data={Tags:"settings_misc_health_display"}] run function uhc:pre_game/menu/selection/settings/misc/health_display/preset_menu
execute unless items entity @s inventory.3 *[minecraft:custom_data={Tags:"settings_misc_team_stuff"}] run return run function uhc:pre_game/menu/selection/settings/misc/preset_menu
...
execute unless items entity @s[tag=uhc.host] inventory.10 *[minecraft:custom_data={Tags:"settings_misc_friendly_fire"}] run function uhc:pre_game/menu/selection/settings/misc/team_stuff/friendly_fire
execute unless items entity @s[tag=uhc.host] inventory.11 *[minecraft:custom_data={Tags:"settings_misc_tracker_allies"}] run function uhc:pre_game/menu/selection/settings/misc/team_stuff/tracker_allies
