...
#> uhc:pre_game/menu/load/gamemode/bhc/grids_check/close
#
...
execute if score #bhc bhc.scenario matches 51 run function uhc:pre_game/menu/load/gamemode/bhc/grids_check/51/disable
execute if score #bhc bhc.scenario matches 91 run function uhc:pre_game/menu/load/gamemode/bhc/grids_check/91/disable
execute if score #bhc bhc.scenario matches 92 run function uhc:pre_game/menu/load/gamemode/bhc/grids_check/92/disable
