...
#item replace entity @s inventory.3 with minecraft:black_concrete[minecraft:item_name=[{"text":"Switch","color":"#6F3FFF","italic":false}],minecraft:custom_data={Tags:"gamemode_switch"}]
