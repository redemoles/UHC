...
$item replace entity @s[scores={uhc.player.lang=061801,uhc.menu.settings.lives=11},tag=uhc.host] inventory.22 with minecraft:totem_of_undying[minecraft:item_name=[{"text":"Nombre de vies > ","color":"#FFFFFF","italic":false},$(lives)],minecraft:custom_data={Tags:"settings_lives"}]
...
$item replace entity @s[scores={uhc.player.lang=051407,uhc.menu.settings.lives=11},tag=uhc.host] inventory.22 with minecraft:totem_of_undying[minecraft:item_name=[{"text":"Number of lives","color":"#FFFFFF","italic":false},$(lives)],minecraft:custom_data={Tags:"settings_lives"}]
