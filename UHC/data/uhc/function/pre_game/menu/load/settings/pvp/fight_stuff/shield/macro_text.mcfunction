...
$item replace entity @s[scores={uhc.player.lang=061801,uhc.menu.settings.pvp=11..20}] inventory.10 with minecraft:shield[minecraft:item_name=[{"text":"Durabilité des boucliers > ","color":"#CFCFCF","italic":false},$(interpreted_2),{"text":"%","color":"#CFCFCF","italic":false}],damage=$(durability),minecraft:custom_data={Tags:"settings_pvp_shield"}]
...
$item replace entity @s[scores={uhc.player.lang=051407,uhc.menu.settings.pvp=11..20}] inventory.10 with minecraft:shield[minecraft:item_name=[{"text":"Shields durability > ","color":"#CFCFCF","italic":false},$(interpreted_2),{"text":"%","color":"#CFCFCF","italic":false}],damage=$(durability),minecraft:custom_data={Tags:"settings_pvp_shield"}]
