...
$loot give @s loot {"type":"minecraft:block","pools":[{"rolls":$(count),"bonus_rolls":0,"entries":[{"type":"minecraft:item","name":"$(id)","functions":[{"function":"minecraft:set_components","components":$(components)}]}]}]}
