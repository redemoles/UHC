...
$execute if score @s uhc.player.lang matches 061801 run item replace entity @s inventory.11 with minecraft:chest[minecraft:item_name=[{"text":"Joueurs par équipe : ","color":"#3FE7FF","italic":false},$(interpreted_2)],minecraft:custom_data={Tags:"team_size"}] $(interpreted_3)
...
$execute if score @s uhc.player.lang matches 051407 run item replace entity @s inventory.11 with minecraft:chest[minecraft:item_name=[{"text":"Players per team : ","color":"#3FE7FF","italic":false},$(interpreted_2)],minecraft:custom_data={Tags:"team_size"}] $(interpreted_3)
