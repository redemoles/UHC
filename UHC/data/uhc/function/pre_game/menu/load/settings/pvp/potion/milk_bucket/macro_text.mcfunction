...
execute if score #milk_bucket uhc.data.setup matches 0 run item replace entity @s[scores={uhc.menu.settings.pvp=31..40,uhc.player.lang=061801}] inventory.10 with minecraft:red_concrete[minecraft:item_name=[{"text":"Seau de lait","color":"#FF3F3F","italic":false}],minecraft:custom_data={Tags:"settings_pvp_milk_bucket"}]
...
execute if score #milk_bucket uhc.data.setup matches 0 run item replace entity @s[scores={uhc.menu.settings.pvp=31..40,uhc.player.lang=051407}] inventory.10 with minecraft:red_concrete[minecraft:item_name=[{"text":"Seau de lait","color":"#FF3F3F","italic":false}],minecraft:custom_data={Tags:"settings_pvp_milk_bucket"}]
