...
execute if score #effect_compatibility_speed_strength uhc.data.setup matches 1 run item replace entity @s[scores={uhc.menu.settings.pvp=31..40,uhc.player.lang=061801}] inventory.11 with minecraft:potion[minecraft:custom_name=[{"text":"Effets force et vitesse compatibles","color":"#3FE7FF","italic":false}],minecraft:potion_contents={custom_color:16762624},minecraft:tooltip_display={"hidden_components":["minecraft:potion_contents"]},minecraft:custom_data={Tags:"settings_pvp_compatibility"}]
...
execute if score #effect_compatibility_speed_strength uhc.data.setup matches 1 run item replace entity @s[scores={uhc.menu.settings.pvp=31..40,uhc.player.lang=051407}] inventory.11 with minecraft:potion[minecraft:custom_name=[{"text":"Strength and speed effects compatible","color":"#3FE7FF","italic":false}],minecraft:potion_contents={custom_color:16762624},minecraft:tooltip_display={"hidden_components":["minecraft:potion_contents"]},minecraft:custom_data={Tags:"settings_pvp_compatibility"}]
