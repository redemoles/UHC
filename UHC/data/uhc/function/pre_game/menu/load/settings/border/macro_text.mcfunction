...
$execute if score @s uhc.player.lang matches 061801 run item replace entity @s inventory.4 with minecraft:heart_of_the_sea[minecraft:item_name=[{"text":"Bordure du monde","color":"#3FE7FF","italic":false}],minecraft:lore=[[{"text":"Taille initiale > ","color":"#FFFFFF","italic":false},$(interpreted_2),{"text":"/","color":"#FFFFFF","italic":false,"bold":false},{"text":"-","color":"#FF3F3F","italic":false,"bold":true},$(interpreted_2)]],minecraft:custom_data={Tags:"settings_border"}]
...
$execute if score @s uhc.player.lang matches 051407 run item replace entity @s inventory.4 with minecraft:heart_of_the_sea[minecraft:item_name=[{"text":"World border","color":"#3FE7FF","italic":false}],minecraft:lore=[[{"text":"Initial size > ","color":"#FFFFFF","italic":false},$(interpreted_2),{"text":"/","color":"#FFFFFF","italic":false,"bold":false},{"text":"-","color":"#FF3F3F","italic":false,"bold":true},$(interpreted_2)]],minecraft:custom_data={Tags:"settings_border"}]
