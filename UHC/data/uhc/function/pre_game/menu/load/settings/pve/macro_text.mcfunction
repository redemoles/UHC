...
$execute if score @s uhc.player.lang matches 051407 run item replace entity @s inventory.2 with minecraft:shield[minecraft:banner_patterns=[{"pattern":"rhombus",color:"red"}],minecraft:item_name=[{"text":"PvE, health points","color":"#B7B7B7","italic":false}],minecraft:lore=[[{"text":"Resistance period > ","color":"#FFFFFF","italic":false},$(interpreted_2),{"text":" minutes","color":"#FFFFFF","italic":false}]],minecraft:tooltip_display={"hidden_components":["minecraft:banner_patterns"]},minecraft:custom_data={Tags:"settings_pve"}]
