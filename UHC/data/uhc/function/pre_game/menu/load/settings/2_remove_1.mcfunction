...
# Réduction dynamique
execute if score @s uhc.menu.settings.border matches 91 unless score #shrink_dynamic uhc.data.setup matches ..0 run scoreboard players remove #shrink_dynamic uhc.data.setup 1
