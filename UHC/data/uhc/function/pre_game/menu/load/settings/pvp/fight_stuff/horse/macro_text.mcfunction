...
execute if score #horse_limit uhc.data.setup matches 0 run item replace entity @s[scores={uhc.menu.settings.pvp=11..20,uhc.player.lang=061801}] inventory.11 with minecraft:red_stained_glass[minecraft:item_name=[{"text":"Chevaux","color":"#FF3F3F","italic":false}],minecraft:custom_data={Tags:"settings_pvp_horse"}]
...
execute if score #horse_limit uhc.data.setup matches 0 run item replace entity @s[scores={uhc.menu.settings.pvp=11..20,uhc.player.lang=051407}] inventory.11 with minecraft:red_stained_glass[minecraft:item_name=[{"text":"Horses","color":"#FF3F3F","italic":false}],minecraft:custom_data={Tags:"settings_pvp_horse"}]
