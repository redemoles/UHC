...
#> uhc:pre_game/menu/load/main/player/main
#
...
execute if score @s uhc.player.lang matches 061801 run item replace entity @s[tag=!uhc.host] inventory.25 with minecraft:ender_pearl[minecraft:item_name=[{"text":"Configuration de la partie","color":"#3FE7FF","italic":false}],minecraft:lore=[[{"text":"Vue observateur","color":"#CFCFCF","italic":true}]],minecraft:custom_data={Tags:"menu_main_host"}]
...
execute if score @s uhc.player.lang matches 051407 run item replace entity @s[tag=!uhc.host] inventory.25 with minecraft:ender_pearl[minecraft:item_name=[{"text":"Game settings","color":"#3FE7FF","italic":false}],minecraft:lore=[[{"text":"Observer view","color":"#CFCFCF","italic":true}]],minecraft:custom_data={Tags:"menu_main_host"}]
