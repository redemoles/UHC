...
#> uhc:pre_game/menu/load/main/player/
#
...
execute if score #random_team uhc.data.setup matches 0 run function uhc:pre_game/menu/load/main/player/team_menu/chosen/
execute if score #random_team uhc.data.setup matches 1 run function uhc:pre_game/menu/load/main/player/team_menu/random/
execute if score #random_team uhc.data.setup matches 2 run function uhc:pre_game/menu/load/main/player/team_menu/random/split
...
execute if score @s uhc.player.lang matches 061801 run item replace entity @s inventory.4 with minecraft:compass[minecraft:item_name=[{"text":"Téléportation","color":"#3FE7FF","italic":false}],minecraft:custom_data={Tags:"teleportation"}]
execute if score @s uhc.player.lang matches 051407 run item replace entity @s inventory.4 with minecraft:compass[minecraft:item_name=[{"text":"Teleportation","color":"#3FE7FF","italic":false}],minecraft:custom_data={Tags:"teleportation"}]
...
execute if score @s uhc.player.lang matches 061801 run item replace entity @s inventory.25 with minecraft:command_block[minecraft:item_name=[{"text":"Configuration de la partie","color":"#3FE7FF","italic":false}],minecraft:custom_data={Tags:"menu_main_host"}]
execute if score @s uhc.player.lang matches 051407 run item replace entity @s inventory.25 with minecraft:command_block[minecraft:item_name=[{"text":"Game settings","color":"#3FE7FF","italic":false}],minecraft:custom_data={Tags:"menu_main_host"}]
