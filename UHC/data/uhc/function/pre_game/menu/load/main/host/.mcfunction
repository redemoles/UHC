...
execute if score @s uhc.player.lang matches 061801 run item replace entity @s inventory.19 with minecraft:light_blue_banner[minecraft:item_name=[{"text":"Paramètres des équipes","color":"#3FE7FF","italic":false}],minecraft:custom_data={Tags:"menu_team_settings"}]
...
execute if score @s uhc.player.lang matches 051407 run item replace entity @s inventory.19 with minecraft:light_blue_banner[minecraft:item_name=[{"text":"Teams settings","color":"#3FE7FF","italic":false}],minecraft:custom_data={Tags:"menu_team_settings"}]
