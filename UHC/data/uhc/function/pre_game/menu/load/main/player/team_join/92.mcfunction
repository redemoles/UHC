...
#> uhc:pre_game/menu/load/main/player/team_join/92
#
...
execute if score #anonyme_team uhc.data.setup matches 0 run team join 092 @s[tag=!mgs.backroom]
execute if score #anonyme_team uhc.data.setup matches 1 run team join 092 @s[tag=!mgs.backroom]
