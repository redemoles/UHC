...
execute unless score #lobby lobby.structure.data matches 13 run item replace entity @s inventory.10 with minecraft:raw_copper_block[minecraft:item_name=[{"text":"BHC - April Fool 2026","color":"#FF3F3F","italic":false}],minecraft:custom_data={"Tags":"lobby_13"}]
execute if score #lobby lobby.structure.data matches 13 run item replace entity @s inventory.10 with minecraft:raw_copper_block[minecraft:item_name=[{"text":"BHC - April Fool 2026","color":"#3FE7FF","italic":false}],minecraft:lore=[[{"text":"Sélectionné","color":"#3FE7FF","italic":false}]],minecraft:custom_data={"Tags":"lobby_13"},minecraft:enchantment_glint_override=true]
