...
execute if score @s uhc.player.lang matches 051407 run item replace entity @s inventory.19 with minecraft:writable_book[minecraft:item_name=[{"text":"Change the default language","color":"#FFE73F","italic":false}],minecraft:custom_data={Tags:"default"}]
