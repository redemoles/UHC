...
$execute if score #sky_high uhc.scenario matches 1 if score #damage_type uhc.scenario.sky_high.settings matches 1 run item replace entity @s inventory.2 with minecraft:phantom_membrane[minecraft:item_name=[{"text":"Sky High","color":"#3FE7FF","italic":false}],minecraft:lore=[[{"text":"At $(sky_high_timer) minutes, players below Y=$(sky_high_height) will loss","color":"#FFFFFF","italic":false}],[{"text":"1 half-heart damage every 30 seconds.","color":"#FFFFFF","italic":false}],[{"text":"Incompatible with ","color":"#FF7F7F","italic":false},{"text":"Go To Hell","color":"#FF3F3F","italic":false}]],minecraft:custom_data={Tags:"scenario_sky_high_enable"}]
