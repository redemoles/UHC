...
function uhc:pre_game/menu/load/scenario/blood_diamond/tier_1/macro_text with storage uhc:scenario blood_diamond


function uhc:pre_game/menu/load/scenario/blood_diamond/tier_2/macro_text with storage uhc:scenario blood_diamond
