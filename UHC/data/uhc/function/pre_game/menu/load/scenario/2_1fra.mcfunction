...
#> uhc:pre_game/menu/load/scenario/2_1fra
#
...
execute if score #rewarding_longshots uhc.scenario matches 1 run item replace entity @s inventory.1 with minecraft:arrow[minecraft:item_name=[{"text":"Rewarding Longshots","color":"#3FE7FF","italic":false}],minecraft:lore=[[{"text":"Toucher des joueurs avec une flèche sera récompensé avec divers items.","color":"#FFFFFF","italic":false}]],minecraft:custom_data={Tags:"scenario"}]
execute if score #sky_high uhc.scenario matches 0 run item replace entity @s inventory.2 with minecraft:red_concrete[minecraft:item_name=[{"text":"Sky High","color":"#FF3F3F","italic":false}],minecraft:lore=[[{"text":"À l'activation du PvP, les joueurs en dessous de Y=150 recevront","color":"#FFFFFF","italic":false}],[{"text":"des dégâts progressifs toutes les 30 secondes.","color":"#FFFFFF","italic":false}],[{"text":"Incompatible avec ","color":"#FF7F7F","italic":false},{"text":"Go To Hell","color":"#FF3F3F","italic":false}]],minecraft:custom_data={Tags:"scenario"}]
execute if score #sky_high uhc.scenario matches 1 run item replace entity @s inventory.2 with minecraft:phantom_membrane[minecraft:item_name=[{"text":"Sky High","color":"#3FE7FF","italic":false}],minecraft:lore=[[{"text":"À l'activation du PvP, les joueurs en dessous de Y=150 recevront","color":"#FFFFFF","italic":false}],[{"text":"des dégâts progressifs toutes les 30 secondes.","color":"#FFFFFF","italic":false}],[{"text":"Incompatible avec ","color":"#FF7F7F","italic":false},{"text":"Go To Hell","color":"#FF3F3F","italic":false}]],minecraft:custom_data={Tags:"scenario"}]
...
execute if score #sound_paranoia uhc.scenario matches 1 run item replace entity @s inventory.3 with minecraft:note_block[minecraft:item_name=[{"text":"Sound Paranoia","color":"#3FE7FF","italic":false}],minecraft:lore=[[{"text":"Chaque joueur entendra un faux son toutes les 1m30 à 7m30.","color":"#FFFFFF","italic":false}]],minecraft:custom_data={Tags:"scenario"}]
...
execute if score #team_health uhc.scenario matches 1 run item replace entity @s inventory.4 with minecraft:apple[minecraft:item_name=[{"text":"Team Health","color":"#3FE7FF","italic":false}],minecraft:lore=[[{"text":"Les points de vie indiqués correspondent","color":"#FFFFFF","italic":false}],[{"text":"aux points de vie de tous les joueurs de l'équipe.","color":"#FFFFFF","italic":false}]],minecraft:custom_data={Tags:"scenario"}]
...
execute if score #trade_uhc uhc.scenario matches 1 run item replace entity @s inventory.5 with minecraft:emerald[minecraft:item_name=[{"text":"Trade UHC","color":"#3FE7FF","italic":false}],minecraft:lore=[[{"text":"Tous les minerais, excepté l'or et le charbon, donnent de l'émeraude.","color":"#FFFFFF","italic":false}]],minecraft:custom_data={Tags:"scenario"}]
