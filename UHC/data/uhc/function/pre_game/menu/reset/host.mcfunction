...
execute if score @s uhc.menu.gamemode.bhc matches 51.. at @s unless entity @p[tag=uhc.host,distance=0.1..,scores={uhc.menu.gamemode.bhc=51..}] run function uhc:pre_game/menu/selected/gamemode/bhc/grids_check/close
