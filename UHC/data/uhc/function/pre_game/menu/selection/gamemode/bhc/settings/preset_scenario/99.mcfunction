...
#> uhc:pre_game/menu/selection/gamemode/bhc/settings/preset_scenario/99
#
...
execute unless score #double_ores uhc.scenario matches 1 run function uhc:pre_game/menu/selection/scenario/list/double_ores
