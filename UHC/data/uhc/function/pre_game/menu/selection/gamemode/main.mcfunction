...
#execute unless items entity @s[tag=uhc.menu.gamemode] inventory.4 *[minecraft:custom_data={Tags:"gamemode_switch"}] run tellraw @s [{"text":"Switch","color":"#6F3FFF","bold":true},{"text":" indisponible","color":"#FF3F3F","bold":false}]
