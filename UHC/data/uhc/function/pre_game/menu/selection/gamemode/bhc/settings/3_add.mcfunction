...
#> uhc:pre_game/menu/selection/gamemode/bhc/settings/3_add
#
...
execute if score @s uhc.menu.gamemode.bhc matches 12 if score #stepa_start bhc.data.setup matches ..299 run scoreboard players add #stepa_start bhc.data.setup 1


# Timer Fin premier Bingo
execute if score @s uhc.menu.gamemode.bhc matches 13 if score #stepa_end bhc.data.setup matches ..299 run scoreboard players add #stepa_end bhc.data.setup 1


# Timer Départ second Bingo
execute if score @s uhc.menu.gamemode.bhc matches 16 if score #stepb_start bhc.data.setup matches ..299 run scoreboard players add #stepb_start bhc.data.setup 1


# Timer Épuisement des ressources second Bingo - Ruée vers l'or
execute if score #bhc bhc.scenario matches 1 if score @s uhc.menu.gamemode.bhc matches 18 if score #stepb_exhaustion bhc.data.setup matches ..299 run scoreboard players add #stepb_exhaustion bhc.data.setup 1


# Timer Fin second Bingo
execute if score @s uhc.menu.gamemode.bhc matches 17 if score #stepb_end bhc.data.setup matches ..299 run scoreboard players add #stepb_end bhc.data.setup 1
