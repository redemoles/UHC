...
execute if score #bhc uhc.gamemode matches 1 if score @s uhc.menu.gamemode.bhc matches 1..11 unless items entity @s inventory.4 *[minecraft:custom_data={Tags:"bhc_docs"}] run return run function uhc:pre_game/menu/load/gamemode/bhc/docs_link
