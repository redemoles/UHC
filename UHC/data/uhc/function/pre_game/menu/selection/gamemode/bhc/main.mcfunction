...
execute unless items entity @s[scores={uhc.menu.gamemode.bhc=01}] inventory.22 *[minecraft:custom_data={Tags:"bhc_scenario"}] run function uhc:pre_game/menu/load/gamemode/bhc/scenario/51
execute unless items entity @s[scores={uhc.menu.gamemode.bhc=01}] inventory.13 *[minecraft:custom_data={Tags:"bhc_scenario"}] run function uhc:pre_game/menu/load/gamemode/bhc/scenario/91
execute unless items entity @s[scores={uhc.menu.gamemode.bhc=01}] inventory.14 *[minecraft:custom_data={Tags:"bhc_scenario"}] run function uhc:pre_game/menu/load/gamemode/bhc/scenario/92
