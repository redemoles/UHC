...
execute if score #loaded lobby.structure.data matches 1 unless score #lobby lobby.structure.data matches 13 unless items entity @s[tag=uhc.menu.lobby] inventory.3 *[minecraft:custom_data={"Tags":"lobby_13"}] run function uhc:pre_game/menu/load/lobby/13
