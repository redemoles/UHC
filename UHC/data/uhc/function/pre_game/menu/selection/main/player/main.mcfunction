...
execute unless items entity @s[tag=!uhc.night_vision] inventory.25 *[minecraft:custom_data={Tags:"night_vision"}] run return run function uhc:pre_game/menu/selection/main/player/light/on
execute unless items entity @s[tag=uhc.night_vision] inventory.25 *[minecraft:custom_data={Tags:"night_vision"}] run return run function uhc:pre_game/menu/selection/main/player/light/off
