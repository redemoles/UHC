...
#> uhc:pre_game/menu/selection/main/player/team/chosen/01-16/12
#
...
execute store result score #temp uhc.data.setup if entity @a[scores={uhc.id.team=12}]
...
execute if score #anonyme_team uhc.data.setup matches 0 run team join 012 @s[tag=!mgs.backroom]
...
scoreboard players set @s uhc.id.team 12
