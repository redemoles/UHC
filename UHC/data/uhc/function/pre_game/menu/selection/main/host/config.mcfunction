...
execute if score @s uhc.player.lang matches 061801 run tellraw @s [{"text":"Vérifications du monde :","color":"#3F9FFF","bold":true}]
execute if score @s uhc.player.lang matches 051407 run tellraw @s [{"text":"World check :","color":"#3F9FFF","bold":true}]
...
execute if score @s uhc.player.lang matches 061801 run tellraw @s [{"text":"Mode de jeu :","color":"#3F9FFF","bold":true}]
execute if score @s uhc.player.lang matches 051407 run tellraw @s [{"text":"Game mode :","color":"#3F9FFF","bold":true}]
$tellraw @s [{"text":"• ","color":"#3F9FFF","bold":true},$(gamemode)]
execute if score @s uhc.player.lang matches 061801 run tellraw @s [{"text":"Scénarios :","color":"#3F9FFF","bold":true}]
execute if score @s uhc.player.lang matches 051407 run tellraw @s [{"text":"Scenarios :","color":"#3F9FFF","bold":true}]
...
execute if score #double_ores uhc.scenario matches 1 run tellraw @s [{"text":"• ","color":"#3F9FFF","bold":true},{"text":"Double Ores","color":"#3FE7FF","bold":false}]
...
execute if score #hastey_boys uhc.scenario matches 1 run tellraw @s [{"text":"• ","color":"#3F9FFF","bold":true},{"text":"Hastey Boys","color":"#3FE7FF","bold":false}]
