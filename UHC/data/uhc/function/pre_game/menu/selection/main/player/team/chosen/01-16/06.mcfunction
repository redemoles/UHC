...
#> uhc:pre_game/menu/selection/main/player/team/chosen/01-16/06
#
...
execute if score #anonyme_team uhc.data.setup matches 0 run team join 006 @s[tag=!mgs.backroom]
