...
execute unless items entity @s inventory.3 *[minecraft:custom_data={Tags:"menu_lobby"}] run return run function uhc:pre_game/menu/load/lobby/
execute unless items entity @s inventory.5 *[minecraft:custom_data={Tags:"menu_gamemodes"}] run return run function uhc:pre_game/menu/load/gamemode/menu
execute unless items entity @s inventory.6 *[minecraft:custom_data={Tags:"menu_scenario"}] run return run function uhc:pre_game/menu/load/scenario/menu_1
...
execute unless items entity @s inventory.24 *[minecraft:custom_data={Tags:"rules_summary"}] run function uhc:pre_game/menu/load/main/host/config with storage uhc:settings
execute unless items entity @s inventory.25 *[minecraft:custom_data={Tags:"menu_player"}] run return run function uhc:pre_game/menu/load/main/player/main
