...
#> uhc:pre_game/menu/selection/main/player/team_menu/random_2_pots
#
...
execute unless score @s[tag=!uhc.random_team.in_a_team] uhc.id.team matches 192 unless items entity @s inventory.14 *[minecraft:custom_data={Tags:"team_192"}] run function uhc:pre_game/menu/load/main/player/team_join/192
