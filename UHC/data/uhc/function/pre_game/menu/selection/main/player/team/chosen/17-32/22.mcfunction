...
#> uhc:pre_game/menu/selection/main/player/team/chosen/17-32/22
#
...
execute if score #anonyme_team uhc.data.setup matches 0 run team join 022 @s[tag=!mgs.backroom]
