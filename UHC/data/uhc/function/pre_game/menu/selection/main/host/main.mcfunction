...
execute unless items entity @s inventory.5 *[minecraft:custom_data={Tags:"menu_gamemodes"}] run return run function uhc:pre_game/menu/load/gamemode/main
...
execute unless items entity @s inventory.19 *[minecraft:custom_data={Tags:"menu_language"}] run return run function uhc:pre_game/menu/load/language/main
