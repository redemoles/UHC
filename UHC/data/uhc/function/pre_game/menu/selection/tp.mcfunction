...
execute unless items entity @s[tag=!mgs.jump] inventory.1 *[minecraft:custom_data={Tags:"tp_center"}] run return run function uhc:pre_game/menu/selection/tp/center
...
execute unless items entity @s[tag=!mgs.jump] inventory.2 *[minecraft:custom_data={Tags:"tp_jump"}] run return run function uhc:pre_game/menu/selection/tp/jump

execute unless items entity @s inventory.25 *[minecraft:custom_data={Tags:"close"}] run return run function uhc:pre_game/menu/load/main/player/main
