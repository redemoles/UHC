...
#> uhc:pre_game/menu/selection/settings/misc/health_display/hp_tab
#
...
execute if score #team_health uhc.scenario matches 0 if score #hp_tab uhc.data.setup matches 0 run scoreboard objectives modify uhc.player.health.auto rendertype integer
execute if score #team_health uhc.scenario matches 1 if score #hp_tab uhc.data.setup matches 0 run scoreboard objectives modify uhc.scenario.team_health.team rendertype integer
