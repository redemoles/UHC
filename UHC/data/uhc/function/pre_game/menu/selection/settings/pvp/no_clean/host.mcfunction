...
#> uhc:pre_game/menu/selection/settings/pvp/team_stuff/host
#
...
execute unless items entity @s inventory.22 *[minecraft:custom_data={Tags:"settings_pvp_no_clean"}] run function uhc:pre_game/menu/load/settings/pvp/no_clean/preset_menu
