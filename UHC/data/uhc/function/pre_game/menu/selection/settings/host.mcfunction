...
execute if score @s uhc.menu.settings.team matches 1.. unless items entity @s inventory.10 *[minecraft:custom_data={Tags:"team_format"}] run return run function uhc:pre_game/menu/load/settings/team/team_format
execute if score @s uhc.menu.settings.team matches 1.. unless items entity @s inventory.11 *[minecraft:custom_data={Tags:"team_size"}] run return run function uhc:pre_game/menu/load/settings/team/team_size/preset_menu
execute if score #random_team uhc.data.setup matches 1.. if score @s uhc.menu.settings.team matches 1.. unless items entity @s inventory.12 *[minecraft:custom_data={Tags:"random_team_instant"}] run return run function uhc:pre_game/menu/load/settings/team/random_now_instant
