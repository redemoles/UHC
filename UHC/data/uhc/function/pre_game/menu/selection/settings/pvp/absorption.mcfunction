...
execute unless items entity @s inventory.4 *[minecraft:custom_data={Tags:"settings_pvp_no_clean"}] run function uhc:pre_game/menu/load/settings/pvp/no_clean/preset_menu
execute unless items entity @s inventory.5 *[minecraft:custom_data={Tags:"settings_pvp_absorption"}] run return run function uhc:pre_game/menu/selection/settings/pvp/preset_menu
