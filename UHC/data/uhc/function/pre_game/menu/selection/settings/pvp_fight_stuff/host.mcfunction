...
#> uhc:pre_game/menu/selection/settings/pvp_fight_stuff/host
#
...
execute unless items entity @s inventory.2 *[minecraft:custom_data={Tags:"settings_pvp_fight_stuff"}] run return run function uhc:pre_game/menu/load/settings/pvp/
...
execute unless items entity @s[scores={uhc.menu.settings.pvp=13}] inventory.22 *[minecraft:custom_data={Tags:"settings_pvp_wolf"}] run function uhc:pre_game/menu/load/settings/pvp/fight_stuff/wolf/
...
execute unless items entity @s inventory.19 *[minecraft:custom_data={Tags:"settings_pvp"}] run function uhc:pre_game/menu/load/settings/pvp/
