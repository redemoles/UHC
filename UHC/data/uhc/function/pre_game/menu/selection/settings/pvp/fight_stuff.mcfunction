...
execute unless items entity @s[tag=uhc.host] inventory.4 *[minecraft:custom_data={Tags:"settings_pvp_no_clean"}] run return run function uhc:pre_game/menu/load/settings/pvp/no_clean/preset_menu
