...
execute unless items entity @s inventory.14 *[minecraft:custom_data={Tags:"settings_absorption"}] run function uhc:pre_game/menu/load/settings/pvp/absorption/preset_menu
