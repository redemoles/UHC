...
execute if score @s uhc.menu.settings.border matches ..10 unless items entity @s inventory.10 *[minecraft:custom_data={Tags:"settings_border"}] run function uhc:pre_game/menu/load/settings/border/shrink_1/preset_menu
execute if score @s uhc.menu.settings.border matches ..10 unless items entity @s inventory.11 *[minecraft:custom_data={Tags:"settings_border"}] run function uhc:pre_game/menu/load/settings/border/shrink_2/preset_menu
execute if score @s uhc.menu.settings.border matches ..10 unless items entity @s inventory.12 *[minecraft:custom_data={Tags:"settings_border"}] run function uhc:pre_game/menu/load/settings/border/shrink_3/preset_menu
