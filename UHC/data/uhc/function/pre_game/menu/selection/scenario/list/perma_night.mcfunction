...
#> uhc:pre_game/menu/selection/scenario/list/perma_night
#
...
execute if score #perma_day uhc.scenario matches 1 if score #perma_night uhc.scenario matches 1 run function uhc:pre_game/menu/selection/scenario/list/perma_day
