...
#> uhc:pre_game/menu/selection/scenario/blood_diamond/3_add_1
#
...
# Fin Palier 1
execute if score @s uhc.menu.scenario.blood_diamond matches 3 unless score #end_tier_1 uhc.scenario.blood_diamond.tier matches 64 run scoreboard players add #end_tier_1 uhc.scenario.blood_diamond.tier 1
execute if score @s uhc.menu.scenario.blood_diamond matches 11 unless score #end_tier_1 uhc.scenario.blood_diamond.tier matches 64 run scoreboard players add #end_tier_1 uhc.scenario.blood_diamond.tier 1

# Fin Palier 2
execute if score @s uhc.menu.scenario.blood_diamond matches 4 unless score #mined_tier_2 uhc.scenario.blood_diamond.tier matches 64 run scoreboard players add #mined_tier_2 uhc.scenario.blood_diamond.tier 1
execute if score @s uhc.menu.scenario.blood_diamond matches 12 unless score #mined_tier_2 uhc.scenario.blood_diamond.tier matches 64 run scoreboard players add #mined_tier_2 uhc.scenario.blood_diamond.tier 1

# Palier 2 - Probabilité de lingot d'or
execute if score @s uhc.menu.scenario.blood_diamond matches 13 run scoreboard players add #tier_2_gold_ingot uhc.scenario.blood_diamond.setup 1
...
execute if score @s uhc.menu.scenario.blood_diamond matches 14 run scoreboard players add #tier_2_damage uhc.scenario.blood_diamond.setup 1
...
execute if score @s uhc.menu.scenario.blood_diamond matches 15 run scoreboard players add #tier_2_gift uhc.scenario.blood_diamond.setup 1
...
execute if score @s uhc.menu.scenario.blood_diamond matches 13..15 run scoreboard players remove #tier_2_diamond uhc.scenario.blood_diamond.setup 1
