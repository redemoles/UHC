...
# Fin Palier 1
execute if score @s uhc.menu.scenario.blood_diamond matches 2 unless score #end_tier_1 uhc.scenario.blood_diamond.tier matches 64 run scoreboard players add #end_tier_1 uhc.scenario.blood_diamond.tier 1

# Fin Palier 2
execute if score @s uhc.menu.scenario.blood_diamond matches 3 unless score #mined_tier_2 uhc.scenario.blood_diamond.tier matches 64 run scoreboard players add #mined_tier_2 uhc.scenario.blood_diamond.tier 1
