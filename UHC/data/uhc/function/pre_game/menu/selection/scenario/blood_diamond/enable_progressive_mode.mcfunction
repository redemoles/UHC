...
#> uhc:pre_game/menu/selection/scenario/blood_diamond/enable_progressive_mode
#
...
execute if score #blood_diamond uhc.scenario matches 1 run return run scoreboard players set #blood_diamond uhc.scenario 0
