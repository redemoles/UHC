...
# Timer Go To Hell
execute if score @s uhc.menu.scenario.restricted_area matches 2 if score #go_to_hell uhc.data.setup matches 1.. run scoreboard players remove #go_to_hell uhc.data.setup 1
