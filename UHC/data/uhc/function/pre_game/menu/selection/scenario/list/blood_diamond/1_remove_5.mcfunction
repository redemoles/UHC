...
#> uhc:pre_game/menu/selection/scenario/list/blood_diamond/1_remove_5
#
...
execute if score @s uhc.menu.scenario.blood_diamond matches 13 if score #tier_2_gold_ingot uhc.scenario.blood_diamond.setup matches 5.. run scoreboard players add #tier_2_diamond uhc.scenario.blood_diamond.setup 5
execute if score @s uhc.menu.scenario.blood_diamond matches 13 if score #tier_2_gold_ingot uhc.scenario.blood_diamond.setup matches ..4 run scoreboard players operation #tier_2_diamond uhc.scenario.blood_diamond.setup += #tier_2_gold_ingot uhc.scenario.blood_diamond.setup
execute if score @s uhc.menu.scenario.blood_diamond matches 13 run scoreboard players remove #tier_2_gold_ingot uhc.scenario.blood_diamond.setup 5
...
execute if score @s uhc.menu.scenario.blood_diamond matches 14 if score #tier_2_damage uhc.scenario.blood_diamond.setup matches 5.. run scoreboard players add #tier_2_diamond uhc.scenario.blood_diamond.setup 5
execute if score @s uhc.menu.scenario.blood_diamond matches 14 if score #tier_2_damage uhc.scenario.blood_diamond.setup matches ..4 run scoreboard players operation #tier_2_diamond uhc.scenario.blood_diamond.setup += #tier_2_damage uhc.scenario.blood_diamond.setup
execute if score @s uhc.menu.scenario.blood_diamond matches 14 run scoreboard players remove #tier_2_damage uhc.scenario.blood_diamond.setup 5
...
execute if score @s uhc.menu.scenario.blood_diamond matches 15 if score #tier_2_gift uhc.scenario.blood_diamond.setup matches 5.. run scoreboard players add #tier_2_diamond uhc.scenario.blood_diamond.setup 5
execute if score @s uhc.menu.scenario.blood_diamond matches 15 if score #tier_2_gift uhc.scenario.blood_diamond.setup matches ..4 run scoreboard players operation #tier_2_diamond uhc.scenario.blood_diamond.setup += #tier_2_gift uhc.scenario.blood_diamond.setup
execute if score @s uhc.menu.scenario.blood_diamond matches 15 run scoreboard players remove #tier_2_gift uhc.scenario.blood_diamond.setup 5
