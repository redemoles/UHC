...
execute unless items entity @s inventory.5 *[minecraft:custom_data={Tags:"scenario"}] run return run function uhc:pre_game/menu/load/scenario/blood_diamond/ with storage uhc:temp blood_diamond
...
execute unless items entity @s inventory.12 *[minecraft:custom_data={Tags:"scenario"}] run function uhc:pre_game/menu/load/scenario/go_to_hell
