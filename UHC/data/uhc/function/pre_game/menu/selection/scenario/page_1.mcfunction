...
# Ligne 2
execute unless items entity @s inventory.10 *[minecraft:custom_data={Tags:"scenario"}] run return run function uhc:pre_game/menu/load/scenario/enchanting_setup/menu
execute unless items entity @s inventory.11 *[minecraft:custom_data={Tags:"scenario"}] run function uhc:pre_game/menu/selection/scenario/experienceless
...
execute unless items entity @s inventory.13 *[minecraft:custom_data={Tags:"scenario"}] run function uhc:pre_game/menu/selection/scenario/gone_fishing
execute unless items entity @s inventory.14 *[minecraft:custom_data={Tags:"scenario"}] run function uhc:pre_game/menu/selection/scenario/hastey_boys
execute unless items entity @s inventory.15 *[minecraft:custom_data={Tags:"scenario"}] run function uhc:pre_game/menu/selection/scenario/no_fall
execute unless items entity @s inventory.16 *[minecraft:custom_data={Tags:"scenario"}] run function uhc:pre_game/menu/selection/scenario/permakill
