...
execute if score @s uhc.menu.scenario.blood_diamond matches ..10 unless items entity @s inventory.1 *[minecraft:custom_data={Tags:"scenario_blood_diamond"}] run return run function uhc:pre_game/menu/selection/scenario/blood_diamond/enable_progressive_mode
execute if score @s uhc.menu.scenario.blood_diamond matches ..10 unless items entity @s inventory.2 *[minecraft:custom_data={Tags:"scenario_blood_diamond"}] run return run function uhc:pre_game/menu/selection/scenario/blood_diamond/enable_traditional_mode
execute unless items entity @s inventory.19 *[minecraft:custom_data={Tags:"scenario_blood_diamond"}] run return run function uhc:pre_game/menu/selection/scenario/blood_diamond/disable
...
execute if score @s uhc.menu.scenario.blood_diamond matches 13.. unless items entity @s inventory.20 *[minecraft:custom_data={Tags:"-5"}] run function uhc:pre_game/menu/selection/scenario/blood_diamond/1_remove_5
execute if score @s uhc.menu.scenario.blood_diamond matches 03.. unless items entity @s inventory.21 *[minecraft:custom_data={Tags:"-1"}] run function uhc:pre_game/menu/selection/scenario/blood_diamond/2_remove_1
execute if score @s uhc.menu.scenario.blood_diamond matches 03.. unless items entity @s inventory.23 *[minecraft:custom_data={Tags:"+1"}] run function uhc:pre_game/menu/selection/scenario/blood_diamond/3_add_1
execute if score @s uhc.menu.scenario.blood_diamond matches 13.. unless items entity @s inventory.24 *[minecraft:custom_data={Tags:"+5"}] run function uhc:pre_game/menu/selection/scenario/blood_diamond/4_add_5
...
execute if score #blood_diamond uhc.scenario matches 1 if score @s uhc.menu.scenario.blood_diamond matches ..10 unless items entity @s inventory.11 *[minecraft:custom_data={Tags:"scenario_blood_diamond_tier_2"}] run return run function uhc:pre_game/menu/selection/scenario/blood_diamond/tier_menu/tier_2
