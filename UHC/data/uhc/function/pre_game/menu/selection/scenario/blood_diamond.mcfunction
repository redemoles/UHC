...
execute if score @s uhc.menu.scenario.blood_diamond matches 1.. unless items entity @s inventory.25 *[minecraft:custom_data={Tags:"close"}] run return run function uhc:pre_game/menu/load/scenario/menu_1
