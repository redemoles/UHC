...
tellraw @a [{"text":"\n[","color":"#6F6F6F","click_event":{"action":"run_command","command":"/trigger uhc.reset"}},{"text":"UHC 26.1.3","color":"#FFE73F"},{"text":" - "},{"text":"pour ","color":"#E7E7E7"},{"text":"MC 1.21.11","color":"#3FE7FF"},{"text":" - "},{"text":"par ","color":"#E7E7E7"},{"text":"Redemoles","color":"#CF3FFF"},{"text":"]"},{"text":"\n\nCliquer sur ce message pour charger le datapack.","color":"#FFFFFF"},{"text":"\nClick on this message to load the datapack.","color":"#CFCFCF","italic":true}]
