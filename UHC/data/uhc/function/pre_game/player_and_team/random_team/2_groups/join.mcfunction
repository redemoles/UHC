...
#> uhc:pre_game/player_and_team/random_team/2_groups/join
#
...
execute unless score @s uhc.id.random_team.ban matches 100..399 run scoreboard players reset #ban uhc.id.random_team.ban
...
execute if entity @a[predicate=uhc:random_team_ban] run function uhc:pre_game/player_and_team/random_team/2_groups/ban
