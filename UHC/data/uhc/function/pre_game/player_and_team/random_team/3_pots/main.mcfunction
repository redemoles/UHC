...
#> uhc:pre_game/player_and_team/random_team/3_pots/main
#
...
function uhc:pre_game/player_and_team/random_team/3_pots/selector

execute as @r[tag=uhc.player] run function uhc:pre_game/player_and_team/random_team/3_pots/color
execute if score #anonyme_team uhc.data.setup matches 0 run function uhc:pre_game/player_and_team/random_team/3_pots/reveal/instant
