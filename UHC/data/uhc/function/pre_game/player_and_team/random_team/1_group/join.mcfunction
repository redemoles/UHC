...
#> uhc:pre_game/player_and_team/random_team/1_group/join
#
...
execute if entity @a[predicate=uhc:random_team_ban] run function uhc:pre_game/player_and_team/random_team/1_group/ban
