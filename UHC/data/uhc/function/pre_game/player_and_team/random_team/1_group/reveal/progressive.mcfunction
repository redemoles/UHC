...
#> uhc:pre_game/player_and_team/random_team/1_group/reveal/progressive
#
...
execute if score #random_team_tick uhc.data.setup matches 30 run function uhc:pre_game/player_and_team/random_team/1_group/reveal/progressive_1

scoreboard players set #random_team_tick uhc.data.setup -1
execute if score #random_team_player uhc.data.setup matches 1.. as @r[tag=uhc.player,team=091] run function uhc:pre_game/player_and_team/random_team/1_group/reveal/progressive_join
