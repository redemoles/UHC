...
#> uhc:pre_game/player_and_team/random_team/1_group/main
#
...
execute if score #anonyme_team uhc.data.setup matches 0 run function uhc:pre_game/player_and_team/random_team/1_group/reveal/instant
