...
#> uhc:pre_game/player_and_team/random_team/2_pots/reveal/progressive
#
...
execute if score #random_team_tick uhc.data.setup matches 30 run function uhc:pre_game/player_and_team/random_team/2_pots/reveal/progressive_1

scoreboard players set #random_team_tick uhc.data.setup -1
execute if score #random_team_player uhc.data.setup matches 1.. as @r[tag=uhc.player,team=092] run function uhc:pre_game/player_and_team/random_team/2_pots/reveal/progressive_join
...
execute if entity @p[tag=uhc.player,team=192] run schedule function uhc:pre_game/player_and_team/random_team/2_pots/reveal/second_split 20t
