...
#> lobby:lobby_map/30/1
#
# @within			lobby:lobby_map/
#
#
# @description		Lobby 30 - Bingo UHC - April Fool 2026
#

place template lobby:lobby_map/30/121 ~-23 ~-49 ~-23
place template lobby:lobby_map/30/111 ~-23 ~-17 ~-23
