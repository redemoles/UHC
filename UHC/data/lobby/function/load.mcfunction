...
scoreboard objectives add lobby.rjg.record.race.score dummy "Score - Jump Battle"
scoreboard objectives add lobby.rjg.record.race.min dummy
scoreboard objectives add lobby.rjg.record.race.sec dummy
scoreboard objectives add lobby.rjg.record.race.ms dummy
scoreboard objectives add lobby.rjg.record.infinite.score dummy "Score - Jump Infini"
scoreboard objectives add lobby.rjg.record.speedrun.score dummy "Score - Jump 150b"
scoreboard objectives add lobby.rjg.record.speedrun.min dummy
scoreboard objectives add lobby.rjg.record.speedrun.sec dummy
scoreboard objectives add lobby.rjg.record.speedrun.ms dummy
...
execute unless score #record lobby.rjg.record.race.score matches 0.. run scoreboard players set #record lobby.rjg.record.race.score 0
...
execute unless score #record lobby.rjg.record.speedrun.score matches 0.. run scoreboard players set #record lobby.rjg.record.speedrun.score 0
