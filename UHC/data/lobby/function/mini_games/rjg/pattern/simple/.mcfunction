...
#> lobby:mini_games/rjg/pattern/simple/
#
...
execute if score #new_block lobby.rjg.z matches 5 unless score #cycle_temp+2 lobby.rjg.score.inv matches 021.. run scoreboard players set #new_block lobby.rjg.z 3
# Z → 2b
...
# Wall Jump
execute unless score @s lobby.rjg.wall_jump matches 0 run scoreboard players set #new_block lobby.rjg.z 4
execute unless score @s lobby.rjg.wall_jump matches 0 run scoreboard players set #new_block lobby.rjg.y 0
...
execute as @n[type=minecraft:marker,tag=mgs.jump.marker,distance=0..,predicate=lobby:rjg/id_player,predicate=lobby:rjg/id_block_and_1] at @s run function lobby:mini_games/rjg/pattern/simple/place with storage rjg:temp new_block
