...
execute unless entity @n[type=marker,tag=mgs.jump.marker,predicate=lobby:rjg/id_player] run return run function lobby:mini_games/rjg/start/id_player/valid_id
