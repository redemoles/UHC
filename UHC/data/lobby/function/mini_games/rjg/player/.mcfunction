...
execute if entity @n[type=minecraft:marker,tag=mgs.jump.marker,predicate=lobby:rjg/id_player,distance=..1.2,predicate=lobby:rjg/id_block_and_1] run function lobby:mini_games/rjg/player/new_block
