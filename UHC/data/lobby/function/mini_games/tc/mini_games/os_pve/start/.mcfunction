...
execute if score #timer_start_tick lobby.tc.data matches 120 as @a[tag=mgs.tc.player] run attribute @s minecraft:max_health modifier add lobby.tc.os_pve -1.0 add_multiplied_total
