...
#> lobby:mini_games/tc/mini_games/os_pve/record/temperature_01/main
#
...
execute if entity @s[tag=!mgs.tc.lr,tag=mgs.tc.pb] run function lobby:mini_games/tc/mini_games/os_pve/record/temperature_01/new_pb
