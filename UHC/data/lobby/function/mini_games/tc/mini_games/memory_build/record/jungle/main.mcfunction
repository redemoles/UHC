...
#> lobby:mini_games/tc/mini_games/memory_build/record/jungle/main
#
...
execute if entity @s[tag=!mgs.tc.lr,tag=mgs.tc.pb] run function lobby:mini_games/tc/mini_games/memory_build/record/jungle/new_pb
