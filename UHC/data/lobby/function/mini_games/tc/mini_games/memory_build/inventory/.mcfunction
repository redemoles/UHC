...
execute if entity @s[tag=mgs.tc.player,tag=!mgs.tc.spec,z=1.0,dz=22] if score @s lobby.tc.inventory matches 1 run clear @s
execute if entity @s[tag=mgs.tc.player,tag=!mgs.tc.spec,z=1.0,dz=22] if score @s lobby.tc.inventory matches 1 run return fail
