...
#> lobby:mini_games/tc/mini_games/parkour/record/chains/main
#
...
execute if entity @s[tag=!mgs.tc.lr,tag=mgs.tc.pb] run function lobby:mini_games/tc/mini_games/parkour/record/chains/new_pb
