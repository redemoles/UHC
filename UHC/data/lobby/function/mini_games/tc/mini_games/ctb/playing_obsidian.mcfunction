...
execute if entity @s[tag=mgs.tc.team.01] as @a[tag=mgs.tc.team.01,scores={uhc.player.lang=061801}] run title @s subtitle [{"text":"L'équipe adverse reçoit surbrillance pendant 40s","color":"#3FE7FF"}]
execute if entity @s[tag=mgs.tc.team.01] as @a[tag=mgs.tc.team.02,scores={uhc.player.lang=061801}] run title @s subtitle [{"text":"Ton équipe reçoit surbrillance pendant 40s","color":"#FF3F3F"}]

execute if entity @s[tag=mgs.tc.team.02] as @a[tag=mgs.tc.team.02,scores={uhc.player.lang=061801}] run title @s subtitle [{"text":"L'équipe adverse reçoit surbrillance pendant 40s","color":"#3FE7FF"}]
execute if entity @s[tag=mgs.tc.team.02] as @a[tag=mgs.tc.team.01,scores={uhc.player.lang=061801}] run title @s subtitle [{"text":"Ton équipe reçoit surbrillance pendant 40s","color":"#FF3F3F"}]
...
execute if entity @s[tag=mgs.tc.team.01] as @s[tag=mgs.tc.team.01,scores={uhc.player.lang=051407}] run title @s subtitle [{"text":"The opposing team receive glowing for 40s","color":"#3FE7FF"}]
execute if entity @s[tag=mgs.tc.team.01] as @s[tag=mgs.tc.team.02,scores={uhc.player.lang=051407}] run title @s subtitle [{"text":"Your team receive glowing for 40s","color":"#FF3F3F"}]

execute if entity @s[tag=mgs.tc.team.02] as @s[tag=mgs.tc.team.02,scores={uhc.player.lang=051407}] run title @s subtitle [{"text":"The opposing team receive glowing for 40s","color":"#3FE7FF"}]
execute if entity @s[tag=mgs.tc.team.02] as @s[tag=mgs.tc.team.01,scores={uhc.player.lang=051407}] run title @s subtitle [{"text":"Your team receive glowing for 40s","color":"#FF3F3F"}]
