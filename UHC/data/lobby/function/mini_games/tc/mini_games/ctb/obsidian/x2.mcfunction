...
execute if entity @s[tag=mgs.tc.team.01] as @s[tag=mgs.tc.team.01,scores={uhc.player.lang=051407}] run title @s subtitle [{"text":"Your team receive ","color":"#3FE7FF"},{"text":"2 points for each sand placed for 20s","color":"#FFFFFF","underlined":true},{"text":" for 20s","color":"#3FE7FF"}]
...
execute if entity @s[tag=mgs.tc.team.02] as @s[tag=mgs.tc.team.02,scores={uhc.player.lang=051407}] run title @s subtitle [{"text":"Your team receive ","color":"#3FE7FF"},{"text":"2 points for each sand placed for 20s","color":"#FFFFFF","underlined":true},{"text":" for 20s","color":"#3FE7FF"}]
