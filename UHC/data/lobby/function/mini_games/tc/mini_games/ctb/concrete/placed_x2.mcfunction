...
#> lobby:mini_games/tc/mini_games/ctb/concrete/placed_x2
#
# @within			lobby:mini_games/tc/mini_games/ctb/concrete/placed_
#
#
# @description		Récompense suite à une concrete posée
#

execute if score @s lobby.tc.red_concrete_powder_placed matches 1 run scoreboard players add #team_01 lobby.tc.player.score 2
...
execute if score @s lobby.tc.red_concrete_powder_placed matches 1 as @a unless entity @s[tag=!mgs.tc.player,tag=!mgs.tc.spec] run title @s title [{"text":"+2","color":"red"}]
...
execute if score @s lobby.tc.red_concrete_powder_placed matches 1 run playsound minecraft:block.note_block.bell master @a[tag=mgs.tc.team.01] ~ ~ ~ 0.5 1 0.5

execute if score @s lobby.tc.blue_concrete_powder_placed matches 1 run scoreboard players add #team_02 lobby.tc.player.score 2
...
execute if score @s lobby.tc.blue_concrete_powder_placed matches 1 as @a unless entity @s[tag=!mgs.tc.player,tag=!mgs.tc.spec] run title @s title [{"text":"+2","color":"blue"}]
...
execute if score @s lobby.tc.blue_concrete_powder_placed matches 1 run playsound minecraft:block.note_block.bell master @a[tag=mgs.tc.team.02] ~ ~ ~ 0.5 1 0.5
