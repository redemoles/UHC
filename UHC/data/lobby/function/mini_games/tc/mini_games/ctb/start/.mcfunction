...
execute if score #timer_start_tick lobby.tc.data matches 190 as @a[tag=mgs.tc.player,scores={uhc.player.lang=061801}] run title @s title [{"text":"Récupère le sable de ta couleur","color":"#FFE73F"}]
execute if score #timer_start_tick lobby.tc.data matches 190 as @a[tag=mgs.tc.player,scores={uhc.player.lang=061801}] run title @s subtitle [{"text":"Pose-le sur le bloc d'or sur ton spawn","color":"#FFFFFF"}]
execute if score #timer_start_tick lobby.tc.data matches 190 as @a[tag=mgs.tc.player,scores={uhc.player.lang=051407}] run title @s title [{"text":"Collect the sand with your color","color":"#FFE73F"}]
execute if score #timer_start_tick lobby.tc.data matches 190 as @a[tag=mgs.tc.player,scores={uhc.player.lang=051407}] run title @s subtitle [{"text":"Put it on the gold block on your spawn","color":"#FFFFFF"}]
...
execute if score #timer_start_tick lobby.tc.data matches 130 as @a[tag=mgs.tc.player,scores={uhc.player.lang=061801}] run title @s title [{"text":"Miner l'obsidienne","color":"#FFE73F"}]
execute if score #timer_start_tick lobby.tc.data matches 130 as @a[tag=mgs.tc.player,scores={uhc.player.lang=061801}] run title @s subtitle [{"text":"Donne un avantage","color":"#FFFFFF"}]
execute if score #timer_start_tick lobby.tc.data matches 130 as @a[tag=mgs.tc.player,scores={uhc.player.lang=051407}] run title @s title [{"text":"Mine the obsidian","color":"#FFE73F"}]
execute if score #timer_start_tick lobby.tc.data matches 130 as @a[tag=mgs.tc.player,scores={uhc.player.lang=051407}] run title @s subtitle [{"text":"Give an advantage","color":"#FFFFFF"}]
