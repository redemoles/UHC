...
# Affiche du résultat
execute if score #timer_end_tick lobby.tc.data matches 80 if entity @p[tag=mgs.tc.finished] as @a[scores={uhc.player.lang=061801}] unless entity @s[tag=!mgs.tc.player,tag=!mgs.tc.spec] run tellraw @s [{"text":""},{"text":"Fin du mini-jeu !","color":"#FFFFFF"},{"text":"\nPoint gagné par "},{"selector":"@a[tag=mgs.tc.finished]"}]
execute if score #timer_end_tick lobby.tc.data matches 80 if entity @p[tag=mgs.tc.finished] as @a[scores={uhc.player.lang=051407}] unless entity @s[tag=!mgs.tc.player,tag=!mgs.tc.spec] run tellraw @s [{"text":""},{"text":"End of the mini-game!","color":"#FFFFFF"},{"text":"\nPoint gained by "},{"selector":"@a[tag=mgs.tc.finished]"}]
execute if score #timer_end_tick lobby.tc.data matches 80 unless entity @p[tag=mgs.tc.finished] as @a[scores={uhc.player.lang=061801}] unless entity @s[tag=!mgs.tc.player,tag=!mgs.tc.spec] run tellraw @s [{"text":""},{"text":"Fin du mini-jeu !","color":"#FFFFFF"},{"text":"\nPersonne n'a gagné de point."}]
execute if score #timer_end_tick lobby.tc.data matches 80 unless entity @p[tag=mgs.tc.finished] as @a[scores={uhc.player.lang=051407}] unless entity @s[tag=!mgs.tc.player,tag=!mgs.tc.spec] run tellraw @s [{"text":""},{"text":"End of the mini-game!","color":"#FFFFFF"},{"text":"\nNobody won a point."}]
execute if score #timer_end_tick lobby.tc.data matches 80 as @a run tag @s remove mgs.tc.finished

# Message pour quitter
execute if score #timer_end_tick lobby.tc.data matches 80 as @a[scores={uhc.player.lang=061801}] unless entity @s[tag=!mgs.tc.player,tag=!mgs.tc.spec] run tellraw @s [{"text":"\nClique ici pour ","color":"#FFFFFF","underlined":true,"bold":true,"click_event":{"action":"run_command","command":"/trigger lobby.tc.player.click_to_join set -1"}},{"text":"quitter","color":"#FF3F3F"},{"text":" la chambre\n"}]
execute if score #timer_end_tick lobby.tc.data matches 80 as @a[scores={uhc.player.lang=051407}] unless entity @s[tag=!mgs.tc.player,tag=!mgs.tc.spec] run tellraw @s [{"text":"\nClick here to ","color":"#FFFFFF","underlined":true,"bold":true,"click_event":{"action":"run_command","command":"/trigger lobby.tc.player.click_to_join set -1"}},{"text":"leave","color":"#FF3F3F"},{"text":" the chamber\n"}]
